...
translate mandarin chapter_1_b85f6f09:
    ...
    "你，Vantacrow Bringer，既是令人生畏的暴君也是英雄團Krisis中的王牌。"
...
translate mandarin chapter_1_33136552:
    ...
    vanta_char "朋友推薦我這個當地的小沙灘，看起來就跟他們說的一樣棒呢。"
...
translate mandarin chapter_1_9e2e96bb:
    ...
    "空氣中充滿了海洋氣息，喧鬧熙攘的人潮都在享受著悠閒的夏日假期。"
...
translate mandarin chapter_1_adcab6d1:
    ...
    "再往前走，有一間的時髦的飲料店，視覺搶眼的飲料吸引了所有人的目光。"
...
translate mandarin cho_one1_accepted_0d88fe92:
    ...
    "在櫃檯付錢後，正當你要離開時，你聽見了商店另一頭傳來的大喊聲。"
...
translate mandarin cho_one1_accepted_a0c318e9:
    ...
    vanta_char "你們應該都知道鐵是不能吃的，對吧？結案！"
...
translate mandarin cho_one1_accepted_25f2d04b:
    ...
    vanta_char "很好。現在你們兩個可以保持冷靜，繼續去享受剩下的時光。"
...
translate mandarin cho_one1_accepted_efbc69f5:
    ...
    npc1_char "謝謝你在事情惡化之前挺身而出，我原本有點擔心你也是來搞事的。"
...
translate mandarin cho_one1_accepted_2bac1b22:
    ...
    npc1_char "呼！我很慶幸我的假設是錯的。你從天而降，就像個英雄！"
...
translate mandarin cho_one1_accepted_1f927595:
    ...
    vanta_char "哈哈！告訴你個事實，我的確是個富有影響力的人，美德的優秀典範。站在你面前的就是——"
...
translate mandarin cho_one1_accepted_4cbbb7b0:
    ...
    npc1_char "我看到越來越多人來到這片海灘。但出於某些原因，他們開始逐漸失控，像今天這樣的爭吵越來越多了。"
...
translate mandarin cho_one1_accepted_f16be9be:
    ...
    npc1_char "我沒有時間去細查，但我的直覺告訴我應該和那間新開的飲料店Octa-Brew有關。"
...
translate mandarin cho_one2_accepted_21332705:
    ...
    "你沿著海灘繼續向前，看見了Octa-Brew外滿滿的人潮，你決定加入排隊。"
...
translate mandarin cho_one3_accepted_fad06044:
    ...
    vanta_char "我可不想又被罵汙染了樣品，最好還是不要亂嚐。"
...
translate mandarin cho_one3_accepted_338976d2:
    ...
    "既然它喝起來挺不錯也沒發生什麼意外，你決定留下這杯飲料，另外再買一杯送回A.S.H. 分析。"
...
translate mandarin JXJX_accepted_fa994762:
    ...
    vanta_char "我應該很快就能收到分析結果。\n現在就讓我好好享受沐浴在陽光下吸收維生素D的時間。"
...
translate mandarin cho_one4_accepted_64cddfce:
    ...
    vanta_char "我是A.S.H. 幹員Vantacrow Bringer，介意我入內看一下你們的廚房嗎？"
...
translate mandarin cho_one4_accepted_1950bd0a:
    ...
    "店員似乎很震驚並且開始恐慌，他抓起一個裝著不明液體的瓶子轉身就逃。"
...
translate mandarin cho_one4_accepted_b199c69e:
    ...
    vanta_char "{size=40}嘿、嘿！你想逃哪去？{/size}"
...
translate mandarin cho_one4_accepted_90a5b298:
    ...
    "你立刻追了上去，而店員著急地想毀滅證據，情急之下將瓶子丟進了海裡。"
...
translate mandarin cho_one4_accepted_04de9b85:
    ...
    "你把店員按倒在地，當你將手銬扣在他手腕上之際，你眼睜睜看著瓶子消失在浪花中。"
...
translate mandarin cho_one4_accepted_575721ff:
    ...
    vanta_char "{size=40}Holy guacamole！{/size}這東西也太巨大了！這什麼鬼東西？"
...
translate mandarin cho_one4_accepted_c7a06350:
    ...
    "你看見一個小孩被絆倒在地正大聲地哭泣，你趕緊衝上前將她抱進懷裡，並帶她撤離到安全處。"
...
translate mandarin BT1_accepted_a16da054:
    ...
    vanta_char "難道這章魚喝了那瓶子裡的東西嗎？那一定就是讓其他人也抓狂的東西！"
...
translate mandarin BT1_accepted_7b6d2c32:
    ...
    "你被無辜地躺在沙子中特別大的一顆貝殼給絆倒，極其笨拙的跌了個狗吃屎。"
...
translate mandarin BT1_accepted_b8c4957f:
    ...
    "由於你的尖叫和你的外表反差太大，連章魚都驚訝地發出震耳欲聾的沉默。"
...
translate mandarin BT1_accepted_694f06b9:
    ...
    vanta_char "{size=50}啊哈！{/size}太容易了！我永遠是對的！"
...
translate mandarin BT1_accepted_95d51c44:
    ...
    "興奮地咧嘴一笑，你轉身揮舞著手來引起章魚的注意，丹田用力大喝一聲後跑開。"
...
translate mandarin after_accepted_762c6637:
    ...
    "你倒掛著，晃動掙扎間看見章魚血紅的雙眼正緊盯著你，彷彿盯著螻蟻。"
...
translate mandarin after_accepted_980073f7:
    ...
    "A.S.H. 小組抵達了現場，同時帶來剛研發完成的解毒劑，派發給現場喝過那杯飲品的人。"
...
translate mandarin after_accepted_bf0ef5fb:
    ...
    "海灘上所有人，包括紀念品店長都在向你和A.S.H. 小組表示感激。"
...
translate mandarin after_accepted_21fb9f74:
    ...
    vanta_char "大家都安全了，我們又可以享受這片祥和美麗的海灘啦。"
...
translate mandarin after_accepted_e87fc705:
    ...
    "你看見每個人臉上的笑容。成功保護他們的喜悅感充斥胸中。又是日常的一天，而你永遠不會對此感到厭倦。"
...
translate mandarin chapter_2_6b6eaf65:
    ...
    "Krisis接到了一項新任務。Zali、Wilson和你一同整裝出發。經過一段短途跋涉後，你們來到了這次任務的目的地。這是一座位於山腳、既安靜又溫馨的小村莊。"
...
translate mandarin chapter_2_e7aa8539:
    ...
    npc4_char "歡迎來到我們的村子，你們就是Krisis吧！你們能這麼快趕來實在是太好了。我是這裡的村長。"
...
translate mandarin chapter_2_76ea7d91:
    ...
    vanta_char "當然了！雖然我們的名氣應該不用介紹⋯⋯我是Vantacrow Bringer，隨時拯救人民的英雄！"
...
translate mandarin chapter_2_7e42440d:
    ...
    zali_char "很高興見到你。我是Vezalius Bandage，我是團隊裡的醫療英雄！"
...
translate mandarin chapter_2_0353087d:
    ...
    npc4_char "對吧！尤其是這個季節，秋天的山巒真的很美！"
...
translate mandarin chapter_2_440b9cee:
    ...
    npc4_char "我們村子長期以出產稀有的蘑菇聞名。但是，我們今年的訂單量比往年多出很多，所以我們決定往山上更深的地方採收。"
...
translate mandarin chapter_2_074ae183:
    ...
    npc4_char "有幾個人受傷了，村民們也受到了不小的驚嚇。他們正在那邊的醫務室休息。"
...
translate mandarin chapter_2_6bd6cf5b:
    ...
    wilson_char "你可以放心交給Zali！他會照顧這些村民的。"
...
translate mandarin chapter_2_1179d30b:
    ...
    vanta_char "我們趕緊準備出發上山吧？得在天黑之前展開調查。"
...
translate mandarin chapter_2_b5c53287:
    ...
    "Zali一邊打斷你們兩個，一邊拋過兩支對講機。你俐落地接著，並把其中一支遞給Wilson。"
...
translate mandarin chapter_2_ade8318d:
    ...
    "你對準備前往醫務室的Zali點頭道別，轉身和Wilson朝山上出發。"
...
translate mandarin chapter_2_67ecc6b3:
    ...
    "巨木參天的森林、腳下沙沙作響的落葉、清新的秋日空氣——眼前的一切都美得令人屏息。"
...
translate mandarin chapter_2_0d2f78ec:
    ...
    wilson_char "還記得我們和Alban、Fulgur一起去森林裡找大腳怪的那次嗎？你整個任務都被公主抱著，真的太搞笑了。啊哈哈哈！"
...
translate mandarin chapter_2_9448744b:
    ...
    "你專注地沿著氣味而去、離開了現在的路線，Wilson的嘮叨聲慢慢消失在你身後。"
...
translate mandarin aut_cho01_accepted_33ba9ed2:
    ...
    wilson_char "{size=40}哈哈哈{/size} ……Vanta，你笨死了！"
...
translate mandarin aut_cho01_accepted_37c54a1d:
    ...
    wilson_char "你就不能找個制高點，觀察「芬想」一下周圍的狀況嗎？哈哈！"
...
translate mandarin aut_cho01_accepted_e49ca88c:
    ...
    "你一邊爬上樹，一邊抓住了一根結實的樹枝，無可避免地搖動了樹枝。"
...
translate mandarin aut_cho01_accepted_d298a2f7:
    ...
    "霎那間，成百上千的蜜蜂接連竄出，尋找打擾它們家的罪魁禍首，空氣中充滿了振翅的嗡嗡聲。"
...
translate mandarin aut_cho01_accepted_3ec11cf2:
    ...
    "你驚慌地從樹上跳下，但有別於平時那樣英勇地落地，你跌跌撞撞地想站穩腳步。"
...
translate mandarin aut_cho01_accepted_8e59a7c1:
    ...
    wilson_char "Vanta？{size=34}VANTA？{/size}你還好嗎？你在嗎？"
...
translate mandarin aut_cho01_accepted_dbe7ae97:
    ...
    vanta_char "不{size=35}不{/size}{size=38}不{/size}{size=41}不{/size}{size=44}不{/size}{size=47}不{/size}{size=50}不！{/size} 你看不到我！你看不到我！你看不到我！"

# game/script.rpy:1638
translate mandarin aut_cho01_accepted_34cb3030:

    # vanta_char "{size=45}WILSON—SHUT UP!!{/size}"
    vanta_char "{size=45}WILSON——閉嘴！！{/size}"
...
translate mandarin aut_cho01_accepted_544ef236:
    ...
    "憤怒的蜜蜂緊追著你。你心跳加快地在森林中高速奔跑，你穿梭於樹木間，試圖甩掉蜜蜂。"
...
translate mandarin aut_cho01_accepted_b5badc3a:
    ...
    "跑贏憤怒的蜜蜂不像打巨型章魚那麼容易，對於普通人來說也不可能做到。但你是Vantacrow Bringer，你不會有失敗的可能。"
...
translate mandarin aut_cho01_accepted_22f980c6:
    ...
    "一個急轉彎時你撞上了什麼，一道黃色的閃光遮住了你的視線。你還來不及站穩，一雙有力的臂膀將你環住，輕鬆地把你抱在懷裡。"
...
translate mandarin aut_cho01_accepted_8c0dcaf9:
    ...
    "驚訝之餘，你發現自己被公主抱著，這意外的相遇讓你一時喘不上氣，你抬起頭看著眼前的……"
...
translate mandarin aut_cho02_accepted_468aa833:
    ...
    "你和Wilson開始地毯式搜索之前村民被襲擊的痕跡。你們調查了灌木叢，撥開樹葉和樹枝，檢查著森林的每一寸。"
...
translate mandarin aut_cho02_accepted_ada7ac1c:
    ...
    "你們找到了一個適合設置陷阱的位置，利用森林的自然資源將陷阱巧妙地隱藏在環境中。"
...
translate mandarin aut_cho02_accepted_a3bdb30c:
    ...
    "在眼前一片五彩斑斕的落葉地毯中，有一隻小熊在快樂地玩耍。空氣中充滿了牠歡快玩舞而沙沙作響的葉子聲。你輕輕吹了聲口哨，讓Wilson注意到那隻在金色樹葉中玩耍的小熊。"
...
translate mandarin aut_cho02_accepted_ed11f874:
    ...
    wilson_char "天啊，那太可愛了吧！我們要不要小心點，確保牠不會意外掉入陷阱。"
...
translate mandarin aut_cho02_accepted_2efba16c:
    ...
    "你的心跳漏了一拍，你們慢慢轉過頭，看向聲音的來源，只見一隻毛皮倒豎的熊，正充滿攻擊性地看著你們。"
...
translate mandarin aut_cho02_accepted_16b89bac:
    ...
    "母熊發出可怕的咆哮，大聲到整個森林為之顫抖。牠散發出異常的煩躁和攻擊性，其異常龐大的身形遠超你之前遇到過的任何熊。"
...
translate mandarin aut_cho02_accepted_e86e4048:
    ...
    wilson_char "快跑{size=35}快跑{/size}{size=38}快跑{/size}！我覺得我們應該跑回Zali那裡去！"
...
translate mandarin aut_cho02_accepted_7202c4b4:
    ...
    "你和Wilson迅速奔向村子大門。你看到Zali的身影，他的存在彷彿讓一盞希望的明燈。"
...
translate mandarin aut_cho02_accepted_ad0491bf:
    ...
    zali_char "{size=34}蛤？什麼鬼？！你們做了什麼？！{/size}"
...
translate mandarin aut_cho02_accepted_92dff5b3:
    ...
    zali_char "我是說「不要受傷」，不是「給我帶個驚喜回來」！"
...
translate mandarin aut_cho02_accepted_37dbdc6d:
    ...
    "Wilson以閃電般反應能力迅速側身躲避，險些避開致命的一擊。然而，熊的巨大力量沖擊了旁邊的一棵樹，大樹應聲而倒。"
...
translate mandarin aut_cho02_accepted_e392cc9c:
    ...
    wilson_char "{size=34}唔啊啊啊啊！！{/size}誰把這東西放在這的？！"
...
translate mandarin aut_cho02_accepted_af53e513:
    ...
    "Wilson從腰帶上拔出電擊槍，在倒掛的同時準確地瞄準並射向眼前的熊。但出乎所有人意料，這隻巨熊只被電暈了幾秒鐘，又要準備發動攻擊。"
...
translate mandarin aut_cho02_accepted_51afd43b:
    ...
    wilson_char "蛤？我的天啊！電擊槍幾乎沒什麼效果，這隻熊是吃了什麼那麼強？"
...
translate mandarin aut_cho02_accepted_4f91dfc9:
    ...
    "正當熊打算再次對Wilson發起攻擊時，Zali的繃帶飛速射向熊的爪子，纏住了牠的動作，阻止了即將到來的攻擊。"
...
translate mandarin aut_cho02_accepted_62f98177:
    ...
    vanta_char "哦，這聽起來很糟糕，我是說{size=40}我快到了！！{/size}"
...
translate mandarin aut_cho02_accepted_37aa6888:
    ...
    vanta_char "……這也聽起來很糟糕，算了。{size=40}我馬上要去你身邊了！！{/size}"
...
translate mandarin aut_cho02_accepted_0c5842ec:
    ...
    zali_char "別怕啊熊熊。很快就會結束，你不會感到任何痛苦的。"
...
translate mandarin aut_cho02_accepted_f81c81a9:
    ...
    "Zali恢復了往常的鎮靜，用安撫的語氣說話。他神不知鬼不覺地掏出一支麻醉槍，在你還沒反應過來時，針頭已經刺入了熊的皮膚。"
...
translate mandarin aut_cho02_accepted_2b845765:
    ...
    "Zali熟練地發射了鎮靜劑，針管中帶有的液體慢慢注入熊的體內。"
...
translate mandarin aut_cho02_accepted_0b10b80e:
    ...
    "屈服於鎮靜劑的效果，熊漸漸失去意識，捆住熊的繃帶也隨之放鬆，睡著的熊隨即倒地。"
...
translate mandarin aut_cho02_accepted_df665b2e:
    ...
    "看著Zali在幾秒鐘內無縫完成的動作，你和Wilson難掩臉上的驚訝。"
...
translate mandarin aut_cho02_accepted_93014b7d:
    ...
    zali_char "沒問題了！這個鎮靜劑會讓熊一直處於沉睡，直到返回總部。"
...
translate mandarin aut_cho02_accepted_1382f578:
    ...
    zali_char "我會讓A.S.H. 的隊伍來帶這隻母熊回去。如果小熊在附近，我也會照顧牠們。"
...
translate mandarin aut_cho02_accepted_8459c3df:
    ...
    zali_char "好啦！沒事啦，一切順利！剛才真的很驚險，幸好都解決了。哈哈哈！"
...
translate mandarin aut_cho02_accepted_bf4bf60e:
    ...
    vanta_char "……他從容不迫地給那隻巨熊注射了神秘的鎮靜劑，整個過程眼睛都不眨一下？"
...
translate mandarin aut_cho02_accepted_bf8cc6cd:
    ...
    "Zali看著你們兩個，表情顯然很困惑，但臉上帶著一如往常的微笑。"
...
translate mandarin aut_cho02_accepted_eb7532c5:
    ...
    "A.S.H. 的後勤團隊在太陽開始下山時趕到現場，帶來了一個為這隻巨熊量身定制的籠子。"
...
translate mandarin aut_cho02_accepted_6933d782:
    ...
    "隨著驚險的戰鬥終於結束，村民們感激地送了豐富的紀念品來表達他們對你們的感謝。"
...
translate mandarin aut_cho02_accepted_26dfefd4:
    ...
    "他們送給你們一些當地製作的楓糖漿和一桶當地特產的蘑菇，每件物品都象徵著他們真摯的謝意。"
...
translate mandarin aut_cho02_accepted_c8efb621:
    ...
    "Zali仔細地檢查這些蘑菇，然後指示後勤團隊將它們存放在A.S.H. 的實驗室。"
...
translate mandarin aut_cho02_accepted_a8069320:
    ...
    zali_char "這些蘑菇看起來很有意思呢……它們有種獨特的味道。我想看看能用它們做些什麼。"
...
translate mandarin aut_cho02_accepted_04425088:
    ...
    "你們三人還享用了村民們準備的美味蘑菇料理，好好地享受了村子的慷慨款待。"
...
translate mandarin aut_cho02_accepted_ebf6d03b:
    ...
    "這座村莊恢復了和平，你們也向村民們告別，這一刻的寧靜深深刻在你的記憶中。"
...
translate mandarin chapter_3_88b4d4f8:
    ...
    "雪花在光禿禿的樹枝上閃閃發光，像是一條閃亮的白毯覆蓋在樹枝上。儘管A.S.H. 大樓的牆壁像堡壘一樣堅固，但你還是可以隔著窗感受到外面的寒冷。"
...
translate mandarin chapter_3_8675c14c:
    ...
    "想要集中精神工作就像用叉子撈雪花一樣困難。你現在只想要把自己裹在溫暖的毯子裡，變成一個毯子墨西哥卷餅。"
...
translate mandarin chapter_3_a0cc0aa7:
    ...
    vanta_char "天啊，接連的任務搞得我好忙。甚至連休假也得工作。我真的應該要趕快處理完這些文件，但我已經坐在這裡好幾個小時了。我需要一些新鮮空氣！"
...
translate mandarin chapter_3_6e27153b:
    ...
    vanta_char "兄弟們，你們要不要喝點什麼？或者吃的？我要去買些零食。"
...
translate mandarin chapter_3_38b1b4f1:
    ...
    wilson_char "噢對！我今天還沒喝咖啡呢！我去泡一杯。Vanta，我可以要一個起司蛋糕嗎，拜託？
"
...
translate mandarin chapter_3_d397e614:
    ...
    zali_char "哦，還有，把報告給我吧Vanta，這個有我罩你。"
...
translate mandarin chapter_3_c6050974:
    ...
    vanta_char "好吧！我順便去看看菜單上有沒有新的季節限定商品！"
...
translate mandarin chapter_3_20675a2e:
    ...
    "你走向門口拿你的外套。當你把外套從衣架上取下時，這異常的重量讓你有點驚訝。"
...
translate mandarin chapter_3_aede8e93:
    ...
    "你拉開外套一看，發現裡面藏著幾個史萊姆。你似乎打擾了他們的午睡。"
...
translate mandarin chapter_3_251da6de:
    ...
    vanta_char "哦！我的Crew！你們在我的外套裡做什麼？在打盹嗎？我吵醒你們了嗎？"
...
translate mandarin chapter_3_d0c13433:
    ...
    "Crew們顯然很不滿意這個決定，他們開始更激烈地跳動，發出抗議的聲音，顯然對被要求留在原地表示不服。"
...
translate mandarin chapter_3_4e68b5cd:
    ...
    "他們開始圍著你的腿團團轉，想阻止你出門。有時候你會想，到底誰才是老大。"
...
translate mandarin chapter_3_91fa6b67:
    ...
    vanta_char "呃啊！好吧好吧！你們真是固執。好了，走吧！"
...
translate mandarin chapter_3_404caf24:
    ...
    "儘管你的語氣中帶著一絲惱火，但你打開了外套，身子前傾讓Crew們跳進去。"
...
translate mandarin chapter_3_d024a46b:
    ...
    "誰知道這群看起來很美味的小東西會這麼麻煩呢？但你也無法拒絕他們，只能當一個不情願的英雄。"
...
translate mandarin chapter_3_bf991aae:
    ...
    "當你走出A.S.H. 總部，一陣冷風迎面吹來；你緊緊地裹住外套，Crew們也擠在你的胸前——對他們來說最棒的地方。"
...
translate mandarin chapter_3_26947deb:
    ...
    "你走到街角的小店「Le Petit Coin」，這名字的意思是「小角落」。"
...
translate mandarin chapter_3_bd9e931a:
    ...
    vanta_char "我想想，我需要買⋯⋯一個起司蛋糕給Wilson、一個可頌、一些甜的⋯⋯還有什麼⋯⋯"
...
translate mandarin win_cho_one1_accepted_d452cefa:
    ...
    "當你走進Le Petit Coin，店裡的溫暖迎面撲來。聖誕節的裝飾點綴著每個角落，從閃爍的燈光到聖誕紅花環，整個空間散發著愉快的光芒。"
...
translate mandarin win_cho_one1_accepted_18a4e7c3:
    ...
    "你忍不住微笑著感受這歡快的氣氛。你帶著興奮的心情，開始在貨架間瀏覽。"
...
translate mandarin win_cho_one1_accepted_39c29576:
    ...
    vanta_char "哦？那邊有一些試吃。我去試試！哦天哪，Zali肯定會討厭這些。"
...
translate mandarin win_cho_one1_accepted_0b9bc450:
    ...
    "看來Le Petit Coin正在推出一種新聖誕節商品——茄子狀棒棒糖。你吃了一口，味道不錯，有著甜美的葡萄味。"
...
translate mandarin win_cho_one1_accepted_f69a0b93:
    ...
    "你決定拿一包給Zali，心想也許，只是也許啦，這能改變他對茄子的看法。"
...
translate mandarin win_cho_one1_accepted_e0d1141a:
    ...
    vanta_char "那是冰淇淋蛋糕嗎？那我一定要買給Wilson。啊哈哈哈！"
...
translate mandarin win_cho_one1_accepted_1ec559e0:
    ...
    vanta_char "我也應該給自己買點喝的。嗯，喝零卡汽水好了？"
...
translate mandarin win_cho_one1_accepted_d61abc25:
    ...
    "Crew們似乎也很興奮。當你走過一棵裝飾精美的聖誕樹時，他們發出歡樂的咕嚕聲。"
...
translate mandarin win_cho_one1_accepted_a2cc13f7:
    ...
    vanta_char "哦？你們喜歡這棵聖誕樹？ {size=40}聖誕快樂！{/size}"
...
translate mandarin win_cho_one1_accepted_1f28dae0:
    ...
    "他們看起來很想跟聖誕樹拍一張照片，你無法抗拒他們的熱情，只好拿出手機。"
...
translate mandarin win_cho_one1_accepted_62367ab2:
    ...
    "你拍了一張興奮的Crew們圍著樹的照片，他們的小身體快樂地跳動著。"
...
translate mandarin win_cho_one1_accepted_2999addf:
    ...
    "突然，有個Crew的小腳腳不小心勾到了燈線上，慌張之下開始拼命拉扯。隨著一個猛拽，電線鬆開了，聖誕樹開始搖晃。"
...
translate mandarin win_cho_one1_accepted_270e3f7d:
    ...
    vanta_char "你們不准再跑到聖誕樹下去了。你們太誇張了！"
...
translate mandarin win_cho_one1_accepted_4c126de5:
    ...
    "你的快速反應穩住了聖誕樹，Crew們很感激你避免了一場潛在的災難。這個小插曲讓你們笑成一團。"
...
translate mandarin win_cho_one1_accepted_e484d93e:
    ...
    "你和閃爍的聖誕樹自拍；Crew們對自己沒在照片裡顯得有點不滿。"
...
translate mandarin win_cho2p_accepted_69777107:
    ...
    "這幾天下的雪已經在公園裡覆上白白的一層雪，在這之中，你注意到一小堆明亮的顏色。"
...
translate mandarin win_cho2p_accepted_a972c826:
    ...
    vanta_char "他的父母在哪？今天天氣這麼冷，我們去看看他還好嗎？"
...
translate mandarin win_cho2p_accepted_d6d56fc1:
    ...
    "Crew們似乎也很關心。其中一個從你的外套裡擠出來，跳在你前面，急切地想確保孩子沒事。"
...
translate mandarin win_cho_one2_accepted_7e06aab1:
    ...
    vanta_char "嘿，孩子，你自己在這裡做什麼？你的家人呢？"
...
translate mandarin win_cho_one2_accepted_4de6fbbc:
    ...
    npc5_char "我⋯⋯我每天都會和我最好的朋友在這個公園玩。但是，她要和家人一起搬到另一個城市了。我們昨天吵了一架，她今天沒有來⋯⋯"
...
translate mandarin win_cho_one2_accepted_423d7ca3:
    ...
    npc5_char "我不應該對她那麼兇。她把她最喜歡的遊戲借給我，現在我可能都沒有機會把這麼重要的東西還給她了⋯⋯"
...
translate mandarin win_cho_one2_accepted_58bc3018:
    ...
    "你注意到他緊緊握著一個遊戲。封面上熟悉的藍色史萊姆讓你想起了Vantacrew。回頭一看，你看到他們在你身後的雪地裡跳來跳去。"
...
translate mandarin win_cho_one2_accepted_51855245:
    ...
    vanta_char "聽著，孩子，如果你的朋友對你很重要，你應該去找她，而不是在這裡等她來找你。"
...
translate mandarin win_cho_one2_accepted_20fcb3a8:
    ...
    npc5_char "但是⋯⋯但是⋯⋯我會不會讓她很煩？如果她不想見我呢？如果她不想再和我做朋友呢？"
...
translate mandarin win_cho_one2_accepted_fa82437a:
    ...
    vanta_char "你知道，有時候不要想太多。你能做什麼就做什麼，該怎麼做就怎麼做。不要害怕向重要的人表達你的感受。"
...
translate mandarin win_cho_one2_accepted_85742131:
    ...
    "在你的鼓勵下，小男孩請求你陪他去找他的朋友。當你們到達他朋友家時，發現他朋友已經搬走了，只剩下一間空屋子。"
...
translate mandarin win_cho_one2_accepted_12683346:
    ...
    "小男孩開始哭泣，你一邊試圖安慰他，一邊環顧四周。你發現剛剛還跟在你身後的Crew們已經不見了。"
...
translate mandarin win_cho_one2_accepted_1fb31e34:
    ...
    "你立刻請Kurococco追踪Crew們的位置。結果顯示他們在一輛移動的車輛裡。"
...
translate mandarin win_cho_one2_accepted_168132a1:
    ...
    vanta_char "孩子，準備好來個小冒險嗎？抓緊了，我們走！\n我會跑得超快，你會感覺像在飛一樣，雖然只是在跑，但你懂我意思吧？"
...
translate mandarin win_cho_one2_accepted_567a216f:
    ...
    "你輕鬆地背起孩子，一邊拿著剛買完東西的購物袋。背著孩子又提著袋子對一個有經驗的英雄來說簡單至極。"
...
translate mandarin win_cho_one2_accepted_302e0036:
    ...
    "當你趕上移動的車輛時，它的速度逐漸減緩，最後在一間房子前停下來。"
...
translate mandarin win_cho_one2_accepted_154e2f10:
    ...
    "看著這群跳來跳去的史萊姆，你不禁想他們那張傻臉的背後肯定啥都沒思考。反正就是頭腦空空，快樂瘋瘋！"
...
translate mandarin win_cho_one2_accepted_50e2a3ba:
    ...
    "你微笑著把男孩想要歸還的遊戲遞給他，輕輕把小男孩轉向他朋友，鼓勵他走向朋友的家。"
...
translate mandarin win_cho_one2_accepted_d4213574:
    ...
    npc5_char "嗨⋯⋯我想說，昨天的事，對不起。\n希望我們還是朋友。我想跟妳再一起玩妳最愛的遊戲。"
...
translate mandarin win_cho_one2_accepted_71beb13b:
    ...
    npc6_char "什麼？我們當然還是朋友呀！我只是想我們可以再見面，這樣我可以在你玩完後拿回來——"
...
translate mandarin win_cho_one2_accepted_ec42807c:
    ...
    npc6_char "是說為什麼有這麼多史萊姆？還有你後面的那個人是誰？他要是做什麼可疑的事我會保護你的。"
...
translate mandarin win_cho_one2_accepted_41134a3f:
    ...
    npc5_char "哦，他啊！嗯，據說他是一個英雄，雖然他沒穿緊身衣⋯⋯應該吧！是他帶我來這裡的。"
...
translate mandarin win_cho_one2_accepted_5e7e2b98:
    ...
    "小男孩現在和他的朋友重逢了，他們看起來心情很好。在父母的包圍下，他們向你揮手告別，然後走進小女孩的新家。"
...
translate mandarin win_cho_one2_accepted_d3e78510:
    ...
    "你對今天作為一個友好的街坊英雄充滿成就感，Crew們也對自己找到了移動的車輛同樣感到自豪。"
...
translate mandarin win_cho_one2_accepted_05865d7d:
    ...
    wilson_char "Vanta，你在幹嘛？Zali和我在等你欸！\n你跑去哪了？還好嗎？"
...
translate mandarin win_cho_one2_accepted_25480f77:
    ...
    vanta_char "噢，抱歉，兄弟，我沒事！\n我臨時被一個小任務耽擱了，剛剛幫助了一個小孩子！"
...
translate mandarin win_cho_one2_accepted_c90c934b:
    ...
    zali_char "我們以為你只是去買些飲料和甜點。Wilson一直擔心你⋯⋯"
...
translate mandarin win_cho_one2_accepted_7f93c4aa:
    ...
    vanta_char "不用，都搞定了。We ball！我現在要回去了，一起吃晚飯吧。"
...
translate mandarin win_cho_one2_accepted_47ee1821:
    ...
    "你注意到購物袋裡的冰淇淋蛋糕已經開始融化了。這可不妙，得趕快放進冰箱。"
...
translate mandarin win_cho_one2_accepted_fe171ce7:
    ...
    vanta_char "我還——嗯，買了些特別的東西給Wilson。"
...
translate mandarin win_cho_one2_accepted_1ff2dba8:
    ...
    "你敞開外套，Crew們自動自發地跳進去依偎著你。儘管冬季的寒風刺骨，但發自內心的溫暖讓你臉上始終掛著微笑。"
...
translate mandarin chapter_4_f6558872:
    ...
    "啊，春天——日照變長了，陽光也變暖了，不幸的是，花粉症也回來了。"
...
translate mandarin chapter_4_faae7733:
    ...
    "當你走進總部時，Zali 已經到了，可能還平常更早一點，周邊圍著幾個 Vezkits。你直接走向廚房，迫不及待地想煮一杯咖啡來開始一天的工作。"
...
translate mandarin chapter_4_fbc1adb1:
    ...
    vanta_char "就是！雖然天氣還是有點陰晴不定，但有些花已經開始盛開了。"
...
translate mandarin chapter_4_7fe9879f:
    ...
    zali_char "對啊！哦，你知道我們應該做什麼嗎？おはなみ！我們應該去賞櫻！"
...
translate mandarin chapter_4_d1c64095:
    ...
    "Wilson 走到咖啡機旁，開始做他的法式香草拿鐵。他準備像往常一樣加入法式香草奶精，卻發現居然用完了。"
...
translate mandarin chapter_4_fd7d8d21:
    ...
    "楓糖漿配 Wilson 的咖啡很搭。嚴格來說，冰淇淋蛋糕也是，但它在冰箱裡放了一陣子了⋯⋯"
...
translate mandarin chapter_4_fb15da94:
    ...
    "如果想開個玩笑，把冰淇淋蛋糕給 Wilson 也很會很有效果。甚至有幾個 Vantacrew 都在竊笑。你決定給 Wilson——"
...
translate mandarin chapter_4_6dd76647:
    ...
    "你忍不住對Ｗilson的反應大笑，而他則是嘟囔幾聲後默默去做他的咖啡了。"
...
translate mandarin chapter_4_8304a501:
    ...
    "即使你非常渴望拿出冰淇淋蛋糕，你還是決定當個神隊友並拿出了楓糖漿。你關上冰箱，把瓶子交給了Wilson。"
...
translate mandarin chapter_4_717c1dac:
    ...
    wilson_char "我的天啊！我記得這個！這不是我們從幫助那村莊中得到的禮物嗎？"
...
translate mandarin spr_cho2_1_accepted_9101f89a:
    ...
    vanta_char "是說，Zali，你會喜歡可頌蠻奇妙的，你不覺得可頌乍看起來有點像茄子的形狀嗎？"
...
translate mandarin spr_cho2_1_accepted_13d7e455:
    ...
    "選擇之一是茄子形狀的棒棒糖，在知道他多痛恨茄子的情況下，送給他這個搞笑禮物一定會得到他很有趣的反應。"
...
translate mandarin spr_cho2_1_accepted_a187cd7e:
    ...
    "另外一個則是你買的可頌吊飾，你當時看到它就想起了Zali。思索再三，你決定送他——"
...
translate mandarin spr_cho2_1_accepted_3f03d2f6:
    ...
    vanta_char "我之前夏天休假的時候在紀念品店買的。其實我應該早點給你，但一直沒有適合的時機。"
...
translate mandarin spr_cho2_1_accepted_4431e93e:
    ...
    "Zali笑著，看起來極為喜歡這份禮物。他的反應讓你覺得心裡非常滿足，你很高興你終於找到機會送給他這份禮物。"
...
translate mandarin spr_cho2_1_accepted_414d2045:
    ...
    "你隨意地一拋，Zali抬手輕易便接住了棒棒糖。他遲疑地打開，小心翼翼地聞了一下，瞇起了雙眼盯著你，而你無畏地朝他豎起大拇指。"
...
translate mandarin spr_cho2_2_accepted_44e98921:
    ...
    "等待外送抵達的同時，你們順便換上了英雄裝，為隨時可能出現的任務做好準備。"
...
translate mandarin spr_cho2_2_accepted_993074ad:
    ...
    "你們三人享受著咖啡和可頌。正當你咬下最後一口，你們的手機同時開始震動。"
...
translate mandarin spr_cho2_2_accepted_b494fd56:
    ...
    zali_char "「我們在Vantacrow其中一次任務中發現了關於某家製藥公司的關鍵線索。」"
...
translate mandarin spr_cho2_2_accepted_3304026f:
    ...
    wilson_char "等等，Vanta，這不就是你上次放暑假發現的地方嗎？"
...
translate mandarin spr_cho2_2_accepted_edbdb4c3:
    ...
    vanta_char "哦對欸！那個大章魚跟可疑的飲料店，怎麼了？"
...
translate mandarin spr_cho2_2_accepted_0ba65693:
    ...
    zali_char "「A.S.H. 的情報部門發現了一處可能是該製藥公司用來掩護其不正當行為的位置。我們需要Krisis潛入指定地點並取得相關數據。」"
...
translate mandarin spr_cho2_2_accepted_99616a69:
    ...
    wilson_char "「此次行動須保持謹慎並避免任何附帶損害。不過，A.S.H. 的A小組將會在附近待命，必要時進行干預，清除任何可能被視為對公眾過於危險的威脅。」"
...
translate mandarin spr_cho2_2_accepted_832423c2:
    ...
    wilson_char "「為了避免任何不可預見的意外發生，Vezkits、Wilsoneers以及Vantacrew也將隨時做好任何所需後援的準備。」"
...
translate mandarin spr_cho2_2_accepted_727bce15:
    ...
    vanta_char "等等，你說的A小組，是那支爆破小組？他們真的要待命嗎？"
...
translate mandarin spr_cho2_2_accepted_2e3cbdaa:
    ...
    wilson_char "看起來是這樣沒錯。總之，我們整裝出發吧。"
...
translate mandarin spr_cho2_2_accepted_78c56a2c:
    ...
    "出任務前的準備對現在的你們彷彿第二天性，你們迅速做好最後的確認，帶上了工具。而你們信任的小夥伴，Tsuchi、Tentapod和Kurococco也做好了準備。"
...
translate mandarin spr_cho2_2_accepted_30ad8559:
    ...
    "你們熟練地潛行到任務簡報中的指定地點，寂靜無聲便進入了建築物。你們目光如炬，觀察著是否有任何值得深入調查的線索。"
...
translate mandarin spr_cho2_2_accepted_f1bb5e72:
    ...
    "Zali、Wilson和你擁有著無以倫比的工作默契，一個簡單的手勢便能清楚傳達彼此的意思。"
...
translate mandarin spr_cho2_2_accepted_f05beef7:
    ...
    wilson_char "這些蘑菇⋯⋯太多蘑菇了吧。他們計畫這件事多久了？"
...
translate mandarin spr_cho2_2_accepted_55cfb7b3:
    ...
    zali_char "等等，這些蘑菇不就是我們去協助村莊採收的蘑菇嗎？我們不是還遇到那隻異常兇猛到比威猛先生還猛的熊嗎？"
...
translate mandarin spr_cho2_2_accepted_bd995243:
    ...
    vanta_char "噢這味道！我想起來了。我就覺得味道很熟悉，這就是我跟章魚惡鬥那次喝的飲料的味道！"
...
translate mandarin spr_cho2_2_accepted_852260f9:
    ...
    wilson_char "他們在利用這些食物進行大規模人體實驗嗎？"
...
translate mandarin spr_cho2_2_accepted_d3cc2ad8:
    ...
    vanta_char "我不知道我們該怎麼處理這麼大量的食物實驗品，看起來我們可能要把這些東西全部摧毀掉。"
...
translate mandarin spr_cho2_2_accepted_f67870f1:
    ...
    zali_char "沒問題，我會通知A小隊這件事，讓他們可以做好準備。"
...
translate mandarin spr_cho2_2_accepted_7f33184c:
    ...
    zali_char "我也聽到了，聽起來像是什麼東西砸到地上的樣子……"
...
translate mandarin spr_cho2_2_accepted_76c24560:
    ...
    vanta_char "嗯哼，我想只能兵來將擋、水淹土擋了。不管門後是什麼，我們都得打起十二分精神應對未知的危險。"
...
translate mandarin spr_cho2_2_accepted_b980f046:
    ...
    "沉重金屬大門隨著輕微洩氣聲緩緩打開，露出一片黑暗，你小心翼翼地踏入，五感高度戒備，蓄勢待發。"
...
translate mandarin spr_cho2_2_accepted_7d234b0a:
    ...
    "你側身讓Zali和Wilson好能看見，在一個小小的金屬籠子裡，一隻幼犬焦慮地又抓又咬，不安地哀鳴，眼神懇求著想被釋放。"
...
translate mandarin spr_cho2_2_accepted_6501f2b6:
    ...
    zali_char "我們要小心點，我們並不知道這隻幼犬是不是已經接受過一些活體實驗。"
...
translate mandarin spr_cho2_2_accepted_aaa212cc:
    ...
    "你用力一扯便扯斷了鎖頭，幼犬彷彿被你的暴力拆解嚇壞了，發出了尖尖細細的哀鳴聲，在籠子裡橫衝直撞。"
...
translate mandarin spr_cho2_2_accepted_ae0b3749:
    ...
    "你迅速把手伸進籠子裡將牠抱出，神奇的是，當牠在你懷裡的那一刻，牠立刻安靜了下來。"
...
translate mandarin spr_cho2_2_accepted_182aa4f6:
    ...
    "牠四隻腳是白色的、彷彿穿著襪子，而腹部的毛色也是奶油白，尾巴則間雜著黑毛，難怪你第一眼會誤認為是狐狸。"
...
translate mandarin spr_cho2_2_accepted_9fbf250f:
    ...
    zali_char "我的天……資料顯示他們對在夏天那場事故中，章魚食用大量蘑菇藥劑後產生的異變出乎意料。"
...
translate mandarin spr_cho2_2_accepted_c6793137:
    ...
    zali_char "於是他們打算實驗在其他動物身上，這隻幼犬就是接下來準備實驗的對象！"
...
translate mandarin spr_cho2_2_accepted_7300636f:
    ...
    "Zali快速地查看電腦，找到了其他目擊者當時錄下整起事件的影片，同時電腦裡也有大量分析不同藥劑配方可能產生的異變數據結果。"
...
translate mandarin spr_cho2_2_accepted_cab7f21e:
    ...
    "Zali將這些資料傳輸到Tsuchi的儲存系統中，確保能即時傳送到A.S.H的情報部門。"
...
translate mandarin spr_cho2_2_accepted_27c3e2b0:
    ...
    vanta_char "我是喝過！但我沒感覺到任何異常阿。我才沒那麼菜。"
...
translate mandarin spr_cho2_2_accepted_43078138:
    ...
    zali_char "但我們在村莊調查的時候，我們也吃了蘑菇料理對吧？\n尤其你還吃得特別多，Vanta。"
...
translate mandarin spr_cho2_2_accepted_a0a42e50:
    ...
    vanta_char "因為沒有什麼熱量嘛，你知道我在控制飲食……如果這樣說的話，那我吃的量應該會讓我出現異變啊？！"
...
translate mandarin spr_cho2_2_accepted_ff01d79b:
    ...
    zali_char "嗯，這只是我的推測，也許你的身體有不同的反應，那物質並沒有影響你。"
...
translate mandarin spr_cho2_2_accepted_e1b43784:
    ...
    zali_char "你加入A.S.H. 後也經歷了一些人體試驗跟測試，本質上你也是我的實驗對象。也許那是你沒有受到影響的原因。"
...
translate mandarin spr_cho2_2_accepted_352a4267:
    ...
    wilson_char "什麼鬼？太酷了吧？早知道我也多吃一些蘑菇了。"
...
translate mandarin spr_cho2_2_accepted_2a0a3be5:
    ...
    wilson_char "萬一呢？萬一我會長更高，變更壯，成為一個美男子。"
...
translate mandarin spr_cho2_2_accepted_21e2cb79:
    ...
    "你跟Zali對看一眼，極有默契地不打算戳破Wilson的幻想。"
...
translate mandarin spr_cho2_2_accepted_0053f173:
    ...
    "幼犬安分待在你懷裡的樣子既舒適又自然，你將牠舉到眼前，他咧嘴看著你彷彿露出了笑容，讓你充滿了難以言喻的喜悅。"
...
translate mandarin spr_cho2_2_accepted_353f439f:
    ...
    vanta_char "之前你只是隻無名柴犬，以後你就不是了。\n從現在起，你屬於我，你就是Vantacrow Bringer的狗狗！"
...
translate mandarin spr_cho2_2_accepted_12c6d8c5:
    ...
    "接收到Wilson的信號，你用力敲下門旁的警報器，刺耳的警報聲頓時響徹整棟大樓，回音在樓梯廊間猛烈撞擊，讓所有人心跳漏了一拍。"
...
translate mandarin spr_cho2_2_accepted_41142d02:
    ...
    wilson_char "{size=35}預計抵達撤離出口的時間：四分二十秒後。{/size}"
...
translate mandarin spr_cho2_2_accepted_43072d85:
    ...
    vanta_char "{size=35}快走吧！跟著我！{/size}"
...
translate mandarin spr_cho2_2_accepted_e62891a9:
    ...
    "幾位保全人員收到實驗室發送警報後立即趕來，你做出備戰姿勢，卻發現他們還來不及對你們舉槍便突然癱倒在地。轉頭一看，你看見Zali握著麻醉槍，平常總是輕鬆的神情此刻顯得特別凝重。"

# game/script.rpy:2702
translate mandarin spr_cho2_2_accepted_aab86b20:

    # zali_char "{size=35}No time to waste, let's move!{/size}"
    zali_char "{size=35}我們沒有時間可以浪費了，走吧。{/size}"
...
translate mandarin spr_cho2_2_accepted_adce0fcf:
    ...
    "多虧警報器，建築物內大多數人員都已撤離，當你們如離弦的箭般衝出大樓時，看到了A小組早已部屬完成，準備引爆。"
...
translate mandarin spr_cho2_2_accepted_73298e4f:
    ...
    "A小組一見到你們的身影便打出手勢引爆炸彈，劇烈的聲響和火光沖天而起，衝擊波在整棟建築物蕩漾開來。"
...
translate mandarin spr_cho2_2_accepted_f1a9a896:
    ...
    "當衝擊波四散朝你而來時，你想起背上的幼犬，立刻轉身讓自己直面爆炸的衝擊波。"
...
translate mandarin spr_cho2_2_accepted_ace27291:
    ...
    "飛塵散去，腎上腺素爆發的餘韻還在，你們三個的心跳仍然緊張地快速跳動。"
...
translate mandarin spr_cho2_2_accepted_5ad29fbf:
    ...
    zali_char "呼……幸好你身上有這個「安全帶」，不然我剛才肯定來不及抓住你。"
...
translate mandarin spr_cho2_2_accepted_359213ba:
    ...
    wilson_char "不好意思啊兩位，麻煩先站好，不然我要被壓扁了。"
...
translate mandarin spr_cho2_2_accepted_6ec38f64:
    ...
    "你邊揉著胸口邊回頭看看幼犬是否安好，幼犬像是通曉你的心意，也轉過頭舔了舔你的耳朵。"
...
translate mandarin spr_cho2_2_accepted_d8d6b8df:
    ...
    wilson_char "看來任務順利解決了！剩下的交給他們處理就好了吧？"
...
translate mandarin spr_cho2_2_accepted_7df46984:
    ...
    wilson_char "我們趕快回去確認一下Vanta的身體狀況。"
...
translate mandarin spr_cho2_2_accepted_5d174c52:
    ...
    zali_char "是，Wilson說的對。Vanta，你感覺怎樣？"
...
translate mandarin spr_cho2_2_accepted_cea7de1b:
    ...
    "面對隊友的擔心，你深吸一口氣後緩緩吐出，喉頭似乎被什麼哽住，聲音有些發顫，剛才驚險的狀況在你腦中重現。"
...
translate mandarin spr_cho2_2_accepted_2374cc69:
    ...
    "隊友們奮不顧身、不顧一切地衝向你，只為了保護你的畫面令你胸口發熱。"
...
translate mandarin spr_cho2_2_accepted_4b8e88c0:
    ...
    vanta_char "我想……我很好。也許一開始我就沒有受到飲料和蘑菇的影響。過去這段時間發生了很多事，即使強大如我，也有脆弱的時候，也有想太多的時候……"
...
translate mandarin spr_cho2_2_accepted_5b0b42d5:
    ...
    "這時，Vezcrewneers不曉得從哪裡冒出來，紛紛圍繞在你們身邊表示關心，提醒著你不管做什麼都有他們的支持。"
...
translate mandarin spr_cho2_2_accepted_74c404c7:
    ...
    vanta_char "以前的Vantacrow Bringer只有一個人，但現在我有你們，我很慶幸擁有你們。"
...
translate mandarin spr_cho2_2_accepted_afc47b13:
    ...
    zali_char "你做得很好，Vanta。我們是一體的。\n雖然有時候我們是Kris，但我們永遠都是Krisis，永遠。"
...
translate mandarin spr_cho2_2_accepted_5ddb9a74:
    ...
    wilson_char "沒錯，從我們第一次合作開始到現在你進步了很多。\n就算你常常跟我唱反調，我也會永遠罩你。"
...
translate mandarin spr_cho2_2_accepted_79ec57b6:
    ...
    "你忍不住笑了出來，彷彿是對你們一起做過的糗事跟吵鬧做出回應。連背後的狗狗也用毛茸茸的頭輕輕頂了你一下，以示鼓勵。"
...
translate mandarin spr_cho2_2_accepted_a9b4e349:
    ...
    "你的笑聲感染了另外兩人，你們一起大聲笑著，分享著無數著讓你們彼此友誼更加堅固的時刻。你彷彿找到了歸屬，你在他們兩人身上找到了家的感覺。"
...
translate mandarin spr_cho2_2_accepted_107fb70b:
    ...
    "櫻花隨著這陣風搖曳，點點灑落在地彷彿是準備為你們鋪出一條花路。\n你和Zali、Wilson攬住彼此，極有默契地向前邁步，將任務現場的混亂拋諸身後。"
...
translate mandarin spr_cho2_2_accepted_d4b3f21b:
    ...
    "隨著你們向前，盛開的花朵預示著新季節的到來。你們踏出的每一步，都代表著將迎接未來更多季節的承諾——充滿著愛與支持，和即將展開的冒險。"
...
# game/script.rpy:2360
translate mandarin chapter_4_787fe774:
    ...
    "Wilson走到咖啡機旁，開始做他的法式香草拿鐵。他準備像往常一樣加入法式香草奶精，卻發現居然用完了。"

# game/script.rpy:2369
translate mandarin chapter_4_41b82195:

    # wilson_char "My coffee creamer."
    wilson_char "我泡咖啡用的奶精。"

# game/script.rpy:2460
translate mandarin spr_cho2_1_accepted_de1c0c17:
...
translate mandarin spr_cho2_1_accepted_3ec36bf9:

    # "An idea pops into your mind, prompting you to glance over your desk."
    "你突然想起一件事，下意識地看向你的辦公桌。"
# TODO: Translation updated at 2024-06-10 13:01

# game/script.rpy:990
translate mandarin chapter_1_4d26ba66:

    # "Further along, there's a trendy drink shop that catches everyone's attention with its visually captivating beverages."
    "再往前走，有一間的時髦的飲料店，視覺搶眼的飲料吸引了所有人的目光。"

# game/script.rpy:1274
translate mandarin after_accepted_2a6d308d:

    # "You parkour through the other waving limbs to get closer to the octopus' body."
    "你在揮舞的觸手之間靈活地跑酷穿梭，眨眼便接近了章魚的主體。"

# game/script.rpy:1955
translate mandarin chapter_3_8a692109:

    # "They start to huddle around your legs to keep you from going out without them. Sometimes you wonder who's really in charge here."
    "他們開始圍著你的腿團團轉，想阻止你出門。有時候你會想，到底誰才是老大。"

# game/script.rpy:2355
translate mandarin chapter_4_16470f3b:

    # wilson_char "Morning guys! You guys aren't seriously going without me, are you?"
    wilson_char "早啊，兩位！你們該不會打算不帶我一起去看櫻花吧？"

# game/script.rpy:2356
translate mandarin chapter_4_f996daac:

    # zali_char " No, we were just talking about it. Don't worry!"
    zali_char "怎麼可能，我們只是在討論而已。別擔心！"

# game/script.rpy:2365
translate mandarin chapter_4_978c5e36:

    # wilson_char "I can't wait!"
    wilson_char "好期待，我等不及了！"

# game/script.rpy:2372
translate mandarin chapter_4_8967df9a:

    # "Wilson walks over to the coffee maker and makes his French vanilla latte. He's about to add the French vanilla coffee creamer, like he normally does, until he realizes that it's not there."
    "Wilson走到咖啡機旁，開始做他的法式香草拿鐵。他準備像往常一樣加入法式香草奶精，卻發現居然用完了。"

# game/script.rpy:2393
translate mandarin chapter_4_e3a14541:

    # wilson_char "You're a lifesaver, thank you!"
    wilson_char "你根本救世主耶，謝啦！"

# game/script.rpy:2402
translate mandarin chapter_4_cd4efb2e:

    # "Maple syrup would work very well with Wilson's coffee. Technically, the same can be said for the ice cream cake, but it's been in here for a while…"
    "楓糖漿配Wilson的咖啡很搭。嚴格來說，冰淇淋蛋糕也是，但它在冰箱裡放了一陣子了⋯⋯"

# game/script.rpy:2403
translate mandarin chapter_4_7effb56d:

    # "But for the content, it's tempting to show off to Wilson. Even a few of the Vantacrew seem to snicker at the notion. You decide to give Wilson—"
    "如果想開個玩笑，把冰淇淋蛋糕給Wilson也很會很有效果。甚至有幾個 Vantacrew 都在竊笑。你決定給Wilson——"

# game/script.rpy:2436
translate mandarin chapter_4_04b04b2b:

    # wilson_char "Oh my god! I remember this! Didn't we get this from that one village we helped out?"
    wilson_char "我的天啊！我記得這個！這不是我們從幫助那村莊中得到的禮物嗎？"

# game/script.rpy:2437
translate mandarin chapter_4_ee28f3c3:

    # vanta_char "Yeah! It's still good, not close to expiring or anything like that."
    vanta_char "沒錯！保存良好，完全沒有過期喔。"

# game/script.rpy:2438
translate mandarin chapter_4_3e3e6911:

    # wilson_char "Now I really can't wait for my coffee! Thank you!"
    wilson_char "我真的等不及泡我的咖啡了！謝啦！"

# game/script.rpy:2461
translate mandarin spr_cho2_1_accepted_ca80a00f:

    # zali_char "Oh, I'm in the mood for that croissant, as always."
    zali_char "噢，我想吃可頌，一直都是。"

# game/script.rpy:2464
translate mandarin spr_cho2_1_accepted_c178eb45:

    # vanta_char "You know, Zali, it's funny that you like croissants because they lowkey look like they're eggplant-shaped."
    vanta_char "是說，Zali，你會喜歡可頌蠻奇妙的，你不覺得可頌乍看起來有點像茄子的形狀嗎？"

# game/script.rpy:2476
translate mandarin spr_cho2_1_accepted_c3580d4d:

    # "Now is the perfect time to give Zali the gift you've been holding onto for a while."
    "現在是送Zali禮物的好時機，事實上你擱置這件事許久。"

# game/script.rpy:2477
translate mandarin spr_cho2_1_accepted_4eb85061:

    # "There's the eggplant-shaped candy: knowing how much he hates eggplant, it would be pretty funny to see his reaction to the gag gift. "
    "選擇之一是茄子形狀的棒棒糖，在知道他多痛恨茄子的情況下，送給他這個搞笑禮物一定會得到他很有趣的反應。"

# game/script.rpy:2485
translate mandarin spr_cho2_1_accepted_caa1dbcf:

    # "You grab the keychain from your desk and return to the kitchen. You tap Zali's shoulder to get his attention. When he turns his head, you show him the croissant keychain."
    "你拿起桌上的吊飾回到廚房，拍了拍Zali的肩膀，當他注意而轉頭過來，你向他展示了可頌吊飾。"

# game/script.rpy:2487
translate mandarin spr_cho2_1_accepted_09ebc6d3:

    # vanta_char "I got it from a souvenir shop while I was on a brief vacation in the summer. I've been meaning to give it to you sooner, but there hasn't been a good time lately."
    vanta_char "我之前夏天休假的時候在紀念品店買的。其實我應該早點給你，但一直沒有適合的時機。"

# game/script.rpy:2513
translate mandarin spr_cho2_1_accepted_3358ce8e:

...
# game/script.rpy:975
translate japanese chapter_1_07c2cbb0:
...
translate japanese chapter_1_bc5a0cab:
    ...
    "ヒーローになってから、あなたは昼夜問わず一生懸命働いてる。\n市民を助け、悪と戦い、「Crazy dayo」や「We Ball! 」といったフレーズをよく使う。"

# game/script.rpy:981
translate japanese chapter_1_d8de0e0b:

    # vanta_char "My first summer vacation has finally started!"
    vanta_char "俺のヒーロー生涯初の夏休みがいよいよ始まったぜ！"

# game/script.rpy:982
translate japanese chapter_1_33136552:

    # vanta_char "My friends recommended this small local beach, it looks just as nice as they said."
    vanta_char "友人に勧められこの小さいビーチに来たんだが、確かに彼らの言う通り素晴らしいところだ。"

# game/script.rpy:985
translate japanese chapter_1_9e2e96bb:

    # "The air is filled with a fresh sea-side breeze, and the hustle and bustle of people enjoying the summer."
    "海の香りで満たされた空気。騒がしい浜辺で、人々がそれぞれの夏を楽しんでいる。"

# game/script.rpy:986
translate japanese chapter_1_adcab6d1:
...
translate japanese cho_one1_accepted_ef1c9284:
    ...
    "店長はあなたの自画自賛のような自己紹介には興味がなさそうだ。"

# game/script.rpy:1053
translate japanese cho_one1_accepted_b173bf4b:

    # "Instead she sighs and starts to talk about the recent events."
    "その代わりに、彼女はため息をついて最近あったことを話し始めた。"

# game/script.rpy:1056
translate japanese cho_one1_accepted_4cbbb7b0:
    ...
    npc1_char "最近このビーチに来る人がどんどん増えているんだけれど、何故かみんな気が狂ったような様子で⋯⋯今日みたいな口論もそこかしこから頻繁に聞こえてくるの。"

# game/script.rpy:1057
translate japanese cho_one1_accepted_bae4f6a7:

    # vanta_char "Did you notice anything that could be causing the fighting?"
    vanta_char "口論の原因になりそうなことはなかったか？"
...
translate japanese JXJX_accepted_fa994762:
    ...
    vanta_char "結果はすぐ出てくるだろう。\nそれまで日の光を浴びてビタミンＤの補給でもするか。"
...
translate japanese cho_one4_accepted_1950bd0a:
    ...
    "店員は突然のことに驚きパニックを起こし、謎の液体が入ったボトルを掴んで逃げようとした。"

# game/script.rpy:1154
translate japanese cho_one4_accepted_b199c69e:

    # vanta_char " {size=40}Hey, hey! Where do you think you're going?{/size}"
    vanta_char "{size=40}おいあんた！どこへ逃げるつもりだ！？{/size}"

# game/script.rpy:1161
translate japanese cho_one4_accepted_90a5b298:

    # "You chase after them, but the clerk, desperate to erase evidence, tosses the bottle into the ocean."
    "あなたはすぐに彼を追いかけたが、店員は証拠隠滅に必死になり、慌ててボトルを海に投げ捨てた。"

# game/script.rpy:1163
translate japanese cho_one4_accepted_04de9b85:
...
translate japanese after_accepted_f0554fde:
    ...
    "幸いあなたは普通の人間ではない。そんなあなたと出会ってしまったタコは、なんとも不運だ。"

# game/script.rpy:1264
translate japanese after_accepted_526bc049:

    # "You gain a huge burst of strength."
    "あなたは意識を集中させ、より大きな力を身体にまとわせた。"

# game/script.rpy:1265
translate japanese after_accepted_a444466a:

    # "You twist your body upwards, punching hard into the tentacles, pushing them back."
    "あなたは体を上に捻り、タコの腕に強烈な一撃をくらわせ追い返した。"

# game/script.rpy:1269
translate japanese after_accepted_56516fac:

    # vanta_char "{size=50}PARCAW !{/size}"
    vanta_char "{size=50}PARCAW!{/size}"

# game/script.rpy:1270
translate japanese after_accepted_e55b27b4:
...
translate japanese after_accepted_980073f7:
    ...
    "A.S.H. の職員たちが完成したばかりの解毒剤を持って現場に到着した。例のドリンクを飲んだ人たちはそれを受け取っていく。"

# game/script.rpy:1312
translate japanese after_accepted_bf0ef5fb:

    # "Everyone on the beach, including the shopkeeper, expresses their thanks to you and the A.S.H. team for averting disaster."
    "お土産屋の店長をはじめ、ビーチにいる全員があなたとA.S.H. チームの助けに感謝をしている。"

# game/script.rpy:1327
translate japanese after_accepted_21fb9f74:

    # vanta_char "Everyone's safe now. We can once again enjoy the beautiful beach in peace."
    vanta_char "もう大丈夫。また安心してこの美しいビーチを楽しむことができる。"

# game/script.rpy:1328
translate japanese after_accepted_e87fc705:
    ...
    "みんなの笑顔が見える。彼らを救った喜びが心に満ちる。こんな日常はいくらあっても飽きることはない。"

# game/script.rpy:1331
translate japanese after_accepted_d8ed6b0c:

    # vanta_char "Well, that was certainly one way for my vacation to go."
    vanta_char "まぁ、これも一つの休暇の過ごし方だよな。"

# game/script.rpy:1332
translate japanese after_accepted_66d94614:

    # "Your adventure has only just begun, and the world awaits your epic journey—"
    "あなたの冒険はまだ始まったばかりだ。ページを開いて壮大な旅に出よう。いざ、世界へーー"

# game/script.rpy:1382
translate japanese chapter_2_6b6eaf65:
    ...
    "Krisisに新たなミッションが与えられた。ザリ、ウィルソン、そしてあなたは準備を整え、目的地に向かった。短い旅の後、あなたたちは山の麓にある小さな村に到着した。静かに過ごせる居心地の良い村だ。"

# game/script.rpy:1383
translate japanese chapter_2_78cc93cb:

    # "The village leader is expecting you upon your arrival."
    "村長があなたたちを出迎えた。"

# game/script.rpy:1385
translate japanese chapter_2_e7aa8539:

    # npc4_char "Welcome to the village, you must be Krisis! I'm so glad you came quickly. I'm the leader of this village."
    npc4_char "ようこそ我が村へ。Krisisのみなさんですよね？こんなにも早く来てくださり嬉しい限りです。私はこの村の村長です。"
...
translate japanese chapter_2_7e42440d:
    ...
    zali_char "お会いできて光栄です。私はヴェザリウス・バンデージ、メディックヒーローとしてKrisisでは医療を担当しています。"

# game/script.rpy:1393
translate japanese chapter_2_02d51d40:

    # wilson_char "We come when you call! I'm Yu Q. Wilson, the most talented hero of our team."
    wilson_char "呼ばれたならすぐ駆けつけるよ！僕はユウ・Ｑ・ウィルソン、チームの中で最も才能のあるヒーローさ。"

# game/script.rpy:1396
translate japanese chapter_2_87bbbba4:

    # zali_char "Um, anyway, this is a lovely village."
    zali_char "それにしても、ここはとても美しい村ですね。"

# game/script.rpy:1401
translate japanese chapter_2_0353087d:

    # npc4_char "Absolutely, especially this time of year; look at how beautiful the mountains are!"
    npc4_char "お褒めいただき嬉しい限りです。この季節は山々が色づいて特に綺麗なんですよ。"

# game/script.rpy:1405
translate japanese chapter_2_edb5116b:

    # "As you discuss the details of the mission, the village leader guides you to the town hall."
    "あなたたちは村長に連れられ、ミッションの詳細を話し合いながら村役場に向かった。"

# game/script.rpy:1407
translate japanese chapter_2_440b9cee:
    ...
    npc4_char "この村は昔からマッシュルームの名産地でねぇ。有り難いことに今年は例年よりも注文が多く、山奥まで採りに行くことにしましたが"

# game/script.rpy:1408
translate japanese chapter_2_90d97ecc:
...
translate japanese chapter_2_0ac7174d:
    ...
    wilson_char "それにみんなで用を足したんだよね！まぁファルガーにお尻を叩かれたことは思い出したくないけど⋯⋯。"

# game/script.rpy:1497
translate japanese chapter_2_0ef4a4f4:

    # vanta_char "Hmm, hold on... What's that smell?"
    vanta_char "ん？待て⋯⋯何の匂いだ？"
...
translate japanese aut_cho01_accepted_a6f3d65b:
    ...
    vanta_char "聞いてくれ。ちょっと厄介なことになった⋯⋯俺、迷子になったかもしれない。自分が今どこにいるのか全くわからん。どうぞ。"
...
translate japanese aut_cho01_accepted_a9f138bb:
    ...
    wilson_char "周りに何があるか教えて。どうぞ。"

# game/script.rpy:1569
translate japanese aut_cho01_accepted_39046746:

    # "You look around, and you answer confidently—"
    "あなたは周りを見回し、自信満々にこう答えた――"

# game/script.rpy:1572
translate japanese aut_cho01_accepted_6283da3f:

    # "The walkie-talkie goes silent, is it broken?"
    "トランシーバーの向こうからは何も返ってこなかった。機械の故障だろうか？"

# game/script.rpy:1573
translate japanese aut_cho01_accepted_bed76fa3:

    # "Suddenly, laughter bursts from the speaker."
    "突然、トランシーバーから爆笑する声が聞こえてきた。"

# game/script.rpy:1577
translate japanese aut_cho01_accepted_33ba9ed2:

    # wilson_char "{size=40}Hahaha...{/size} Vanta, you're so stupid!"
    wilson_char "{size=40}ハハハ⋯⋯{/size}何バカなこと言ってるんだベンタ！"

# game/script.rpy:1578
translate japanese aut_cho01_accepted_4f605227:

    # wilson_char "Just stay still, and I'll find you. Over."
    wilson_char "そこでじっとしてて。僕がそっちに向かうから。どうぞ。"

# game/script.rpy:1585
translate japanese aut_cho01_accepted_f13448ba:

    # vanta_char "Bro, I know this sounds insane, but the cloud I'm under actually looks like Tentapod! Over."
    vanta_char "兄弟、これはふざけてるように聞こえるかもしれないが、俺の上にある雲の形はさ、実はテンタポッドに似ているんだ。どうぞ。"
...
translate japanese aut_cho01_accepted_8039b810:
    ...
    vanta_char "ウィルソン！お前、俺の不幸を楽しんでるだろ！？大きな木を見つけた。それに登って一旦見てみる。どうぞ。"

# game/script.rpy:1610
translate japanese aut_cho01_accepted_e49ca88c:

    # "As you climb up the tree, you reach for a sturdy branch, inadvertently shaking it."
    "木に登っている最中、丈夫な枝に手を伸ばしうっかり揺らしてしまった。"

# game/script.rpy:1611
translate japanese aut_cho01_accepted_cdd07e9a:

    # "Suddenly, a bee hive plummets to the forest floor; you don't feel very good about this."
    "すると枝についていた蜂の巣が地面に落ちてしまった。嫌な予感がする。"

# game/script.rpy:1618
translate japanese aut_cho01_accepted_f09bf3eb:

    # vanta_char "{size=34}ARE YOU SERIOUS? PINEAPPLES!{/size}"
    vanta_char "{size=34}バカッ！マジかよ！{/size}"

# game/script.rpy:1619
translate japanese aut_cho01_accepted_64030590:

    # "Yes, we are serious."
    "うん。ガチのマジ。"

# game/script.rpy:1621
translate japanese aut_cho01_accepted_d298a2f7:

    # "The air fills with buzzing as hundreds of bees swarm around, seeking the source of the disturbance to their home."
    "何百もの蜜蜂が巣から飛び出し、自分たちの家を壊そうとしてる元凶を探し始めた。山の中にはブンブンという音が響く。"

# game/script.rpy:1622
translate japanese aut_cho01_accepted_8f370c80:

    # "You are so distraught that you can't hear Wilson calling for you from the walkie-talkie."
    "取り乱したあなたは、トランシーバーから聞こえてくるあなたを呼ぶウィルソンの声に気づくことはなかった。"

# game/script.rpy:1623
translate japanese aut_cho01_accepted_75844b0c:

    # vanta_char "{size=34}Oh shittake mushroom—{/size}"
    vanta_char "{size=34}くっそマッシュルームが――{/size}"
...
translate japanese aut_cho01_accepted_14011006:
    ...
    vanta_char "{size=45}ああああああああ！！！{/size}"
...
translate japanese aut_cho01_accepted_8e59a7c1:
    ...
    wilson_char "ベンタ？{size=34}ベンタクロウ？{/size}大丈夫？生きてる？"

# game/script.rpy:1636
translate japanese aut_cho01_accepted_017bf934:

    # wilson_char "Answer me! Tell me what's going on! OVER!"
    wilson_char "応答して！一体何があったんだよ！どうぞ！"

# game/script.rpy:1637
translate japanese aut_cho01_accepted_dbe7ae97:
    ...
    vanta_char "いや{size=35}いや{/size}{size=38}いや{/size}{size=41}いや{/size}{size=44}見えてない{/size}{size=47}見えてない{/size}！お前は俺のことが見えてない！！"

# game/script.rpy:1638
translate japanese aut_cho01_accepted_34cb3030:

    # vanta_char "{size=45}WILSON—SHUT UP!!{/size}"
    vanta_char "{size=45}ウィルソン――黙ってろ！{/size}"

# game/script.rpy:1639
translate japanese aut_cho01_accepted_609e3e64:

    # vanta_char "{size=45}AHHHHHH!{/size}"
    vanta_char "{size=45}あああああ！！！{/size}"
...
translate japanese aut_cho01_accepted_b5badc3a:
    ...
    "巨大なタコとの戦い以上に苦戦した。そもそも普通の人間には不可能だ。しかしあなたはベンタクロウ・ブリンガー。あなたの辞書に「負け」の文字はない。"

# game/script.rpy:1645
translate japanese aut_cho01_accepted_afd5a046:

    # "You don't know how long you've been bolting, but the pursuit of the bees gradually fades into the distance."
    "どれくらい走ってたかわからないが、蜜蜂の追跡は徐々に遠ざかっていく。"

# game/script.rpy:1646
translate japanese aut_cho01_accepted_22f980c6:
    ...
    "慌てて角を曲がると視界に見知った黄色が入ってきた。あなたは体勢を整えようとしたが、それよりも早く力強い腕に捕まりさらっと抱き上げられた。"
...
translate japanese aut_cho01_accepted_44a60453:
...
translate japanese aut_cho01_accepted_a3e86e1b:
    ...
    wilson_char "もう下ろしていい？"

# game/script.rpy:1657
translate japanese aut_cho01_accepted_dc0087e7:

    # vanta_char "Wh—How would I know there would be a beehive on that tree?!"
    vanta_char "な――蜂の巣があるなんてわかるもんか！？"

# game/script.rpy:1658
translate japanese aut_cho01_accepted_4933255f:

    # vanta_char "Anyway, thanks for the lift."
    vanta_char "それはともかく、抱き上げてくれてありがとな。"

# game/script.rpy:1679
translate japanese aut_cho02_accepted_02264c4f:

    # "The two heroes finally reunite; now they can valiantly press on with their mission."
    "二人のヒーローはやっと再会し、これで勇敢に任務を続けることができる。"

# game/script.rpy:1680
translate japanese aut_cho02_accepted_468aa833:
    ...
    "あなたは今ウィルソンと共に村人たちが襲われた痕跡を探している。茂みをかき分け、葉っぱや枝も分けて、森の隅から隅まで念入りに見たり調べてたりしていた。"

# game/script.rpy:1681
translate japanese aut_cho02_accepted_ada7ac1c:
    ...
    "あなたたちは罠を仕掛けれる良い所を見つけ、カモフラージュ用の自然素材を撒いて、ちゃんと隠せるようにしていた。"

# game/script.rpy:1682
translate japanese aut_cho02_accepted_a3bdb30c:
    ...
    "鮮やかな落ち葉の絨毯の中で、遊び好きな子グマがはしゃいで戯れている。そこは気ままなダンスと葉が擦れる音で満たされていた。黄金色の葉の間にいる子グマをウィルソンに知らせるため、あなたは口笛を吹いた。"
...
translate japanese aut_cho02_accepted_65fbb8a5:
    ...
    vanta_char "そうだな！じゃあ罠に近づかないよう、俺が葉っぱで子グマを誘い出そう。"

# game/script.rpy:1689
translate japanese aut_cho02_accepted_73d9d90d:

    # wilson_char "Oh no, if the cub is here..."
    wilson_char "待って。ここに子グマがいるってことは⋯⋯。"

# game/script.rpy:1692
translate japanese aut_cho02_accepted_1eb96c34:

    # wilson_char "Then the mama bear must be nearby, we should watch out—"
    wilson_char "母グマもきっと近くにいるはずだ。気をつけないと――"

# game/script.rpy:1698
translate japanese aut_cho02_accepted_4d6bf3ff:

    # "All of a sudden, a low, rumbling growl echoes from behind you."
    "突然後ろから低い唸り声が聞こえてくる。"

# game/script.rpy:1699
translate japanese aut_cho02_accepted_2efba16c:
    ...
    "心臓をバクバクさせながら、あなたはその不吉な音の方に顔を向けた。そこには毛を逆立てたクマがあなたたちを見つめていた。"

# game/script.rpy:1700
translate japanese aut_cho02_accepted_6ab04348:

    # "Ah, just what you need—another item checked off the bucket list:\nGetting chased by a bear. How thrilling!"
    "あぁ……「死ぬ前にやりたいことリスト」からまた一つ項目を消すことができそうだ――荒れ狂うクマに追いかけられること。スリル満点だ！"

# game/script.rpy:1712
translate japanese aut_cho02_accepted_16b89bac:
    ...
    "異常に動揺していた母グマは威嚇するように、森全体が震えるほどの恐ろしい声をあげた。母グマはあなたがこれまでに遭遇したどのクマよりも遥かに大きい。"

# game/script.rpy:1713
translate japanese aut_cho02_accepted_f8e52700:

    # "You and Wilson pause for a second, exchanging a look that says, 'Deuces!'"
    "あなたとウィルソンは一瞬動きを止め、「お先に失礼します」という視線を交わした。"

# game/script.rpy:1716
translate japanese aut_cho02_accepted_631d93bc:

    # "Without saying a word, you read your homie's mind, and simultaneously turn on your heels, racing down the mountain."
    "あなたたちは以心伝心、一心同体で踵を返し、素早く山を駆け下りた。"

# game/script.rpy:1723
translate japanese aut_cho02_accepted_56b99fad:

    # wilson_char "Vanta? That's not just an angry bear!!"
    wilson_char "ベンタ？あれはただの怒ったクマじゃないぞ！！"

# game/script.rpy:1724
translate japanese aut_cho02_accepted_e86e4048:

    # wilson_char "GO {size=35}GO{/size} {size=38}GO!{/size} I think we should go back to Zali!"
    wilson_char "走れ{size=35}走れ{/size} {size=38}走れ！{/size} ザリのところに戻ろう！"
...
translate japanese aut_cho02_accepted_dc1742f0:

    # vandw_char "{size=45}AHHHHHHHHH!!!{/size}"
    vandw_char "{size=45}うわああああぁぁぁぁ！！！{/size}"

# game/script.rpy:1735
translate japanese aut_cho02_accepted_7202c4b4:

    # "You and Wilson rapidly approach the village entrance. You see Zali, his presence a beacon of hope."
    "あなたとウィルソンは物凄いスピードで村の入り口まで走った。ザリが見えた！彼が希望の光のように見えた。"

# game/script.rpy:1738
translate japanese aut_cho02_accepted_ad0491bf:

    # zali_char "{size=34}What the hell?! What did you guys do?!{/size}"
    zali_char "{size=34}はっ？なんなの！？何をやっていたんだい君たちは！？{/size}"

# game/script.rpy:1739
translate japanese aut_cho02_accepted_92dff5b3:

    # zali_char "I said, 'Don't get hurt', not 'Bring me a surprise!'"
    zali_char "私は『怪我をしないように』と言ったけど、『驚かせて』とは言ってない！"

# game/script.rpy:1742
translate japanese aut_cho02_accepted_a416d865:

    # "The bear catches up to the three of you, slashing towards Wilson."
    "クマはあなたたち三人に追いつき、その鋭い爪がウィルソンに襲いかかる。"

# game/script.rpy:1743
translate japanese aut_cho02_accepted_37dbdc6d:
    ...
    "ウィルソンは電光石火で間一髪、致命的な一撃を避けることができた。クマの攻撃は勢いのまま近くにあった木に当たり、木は地面に倒れてしまった。"

# game/script.rpy:1748
translate japanese aut_cho02_accepted_6a85ced6:

    # wilson_char "HA! You can't lay a finger on the best former hitman ever—"
    wilson_char "ハハッ！史上最強の元殺し屋には指一本触れさせないぜ――"

# game/script.rpy:1749
translate japanese aut_cho02_accepted_e392cc9c:

    # wilson_char "{size=34}WOAHHHH!!{/size} Who put this thing here?!"
    wilson_char "{size=34}っうわぁぁぁ！！{/size}誰だよここにこんなもん置いたのは！？！？"
...
translate japanese aut_cho02_accepted_b0f2551d:
    ...
    zali_char "ウィルソン！テーザー銃を使え！"

# game/script.rpy:1756
translate japanese aut_cho02_accepted_af53e513:
    ...
    "ウィルソンはベルトからテーザー銃を抜き、逆さまにぶら下がったまま目の前のクマに確実に狙いを定めて発砲した。驚いたことに、その一撃はクマを数秒間気絶させただけだった。クマは再び襲いかかろうとしている。"

# game/script.rpy:1757
translate japanese aut_cho02_accepted_51afd43b:

    # wilson_char "MY GOD! That barely did anything, just how strong is this bear?"
    wilson_char "はぁ！？テーザー銃が効いてないじゃん！どんだけ強いんだあのクマ！"

# game/script.rpy:1758
translate japanese aut_cho02_accepted_b6b2b502:
    ...
    "あなたは素早く状況を判断し、ウィルソンの元へ駆け寄り罠を解き始めた。一刻も早く危険な状態から彼を解放しなくては。"

# game/script.rpy:1763
translate japanese aut_cho02_accepted_44496eb6:

    # vanta_char "Wilson, hang in there!"
    vanta_char "ウィルソン！しっかりしろ！"
...
translate japanese aut_cho02_accepted_493d10fa:
    ...
    "早く解かないと、またクマが襲いかかってくる――"

# game/script.rpy:1768
translate japanese aut_cho02_accepted_28680a4e:

    # zali_char "Vanta! The bear!!! {size=40}WILSON—{/size}"
    zali_char "ベンタ！クマが！！！{size=40}ウィルソン――{/size}"

# game/script.rpy:1771
translate japanese aut_cho02_accepted_4f91dfc9:
    ...
    "クマがウィルソンに再び襲いかかろうとした瞬間、ザリの包帯がクマの爪の動きを絡め取り、迫り来る攻撃を見事に止めた。"

# game/script.rpy:1772
translate japanese aut_cho02_accepted_06a113cb:

    # "The bear's immense strength begins to strain the bandages, causing them to fray as they are pulled."
    "しかしクマの強い力で包帯は少しずつ破れてきた。"

# game/script.rpy:1773
translate japanese aut_cho02_accepted_ec616bf0:

    # "As elegant as Zali has always been, his voice carries a tone of genuine concern for his teammates."
    "ザリはいつものように優雅でいるが、心から仲間たちを心配していることが彼の声に滲んでいる。"

# game/script.rpy:1774
translate japanese aut_cho02_accepted_c2d55067:

    # zali_char "{size=40}I won't let you hurt Wilson!!{/size}"
    zali_char "{size=40}ウィルソンは傷付けさせない！！{/size}"

# game/script.rpy:1775
translate japanese aut_cho02_accepted_f9533716:

    # zali_char "UGHHHH!! Van..ta!! I can't hold this forever!"
    zali_char "クッ⋯⋯！ベン⋯⋯タッ、私一人だけじゃ長くは保たない！"
...
translate japanese aut_cho02_accepted_afd7214c:
    ...
    "ウィルソンを解放した後、あなたはすぐザリのところに向かっていく。"
...
translate japanese aut_cho02_accepted_e3da8d54:
    ...
    "罠から解放されたウィルソンの足が地面についた瞬間、彼は前に突っ走りクマに襲い掛かっていく。"

# game/script.rpy:1784
translate japanese aut_cho02_accepted_f91a2888:

    # vandw_char "{size=45}EUHHHHH AHHHHHH!!! ZALI! RIGHT NOW!!{/size}"
    vandw_char "{size=45}はぁぁぁあああああ！！！ザリ！今だ！{/size}"

# game/script.rpy:1785
translate japanese aut_cho02_accepted_0c5842ec:

    # zali_char "Don't worry, bear. This will be over quickly, and you won't feel a thing."
    zali_char "心配ないよクマさん。何も感じない間に終わっているからね。"
...
translate japanese aut_cho02_accepted_8459c3df:
    ...
    zali_char "よし！やったねみんな。ちょっと危なかったけど、最後はうまくいって良かったよ。ハハッ！"

# game/script.rpy:1816
translate japanese aut_cho02_accepted_14b4ccf7:

    # wilson_char "V… Vanta?"
    wilson_char "ベ、ベンタ⋯⋯？"

# game/script.rpy:1817
translate japanese aut_cho02_accepted_7335cd67:

    # vanta_char "… Yeah?"
    vanta_char "⋯⋯何だ？"

# game/script.rpy:1818
translate japanese aut_cho02_accepted_4b868393:

    # wilson_char "Did you see what Zali just did?"
    wilson_char "ザリがやったことを、見た？"
...
translate japanese aut_cho02_accepted_4e497d03:
    ...
    "あなたとウィルソンは背筋が凍るのを感じた。"

# game/script.rpy:1821
translate japanese aut_cho02_accepted_84f63e3b:

    # "Once again, you can read your homie's mind."
    "またしてもお互いの心を読めた。"

# game/script.rpy:1822
translate japanese aut_cho02_accepted_b14cff75:
...
translate japanese aut_cho02_accepted_aac8b166:
    ...
    zali_char "二人とも変な顔をしているね。私何かやらかしたかい？"

# game/script.rpy:1825
translate japanese aut_cho02_accepted_4529ff8c:

    # vandw_char "{size=50}No-nothing!{/size}"
    vandw_char "べ、別に何も！"

# game/script.rpy:1841
translate japanese aut_cho02_accepted_eb7532c5:
    ...
    "日が暮れる頃、A.S.H.の輸送チームが現場に到着し、巨大なクマを収容するための特注の檻を持ってきた。"

# game/script.rpy:1842
translate japanese aut_cho02_accepted_6933d782:
    ...
    "厳しい戦いもようやく終わった。あなたたちの努力に感謝の気持ちを込めて、村人たちはたくさんのお土産を用意してくれていた。"

# game/script.rpy:1843
translate japanese aut_cho02_accepted_26dfefd4:
...
translate japanese aut_cho02_accepted_32bc7a4f:
    ...
    "一枚の紅葉があなたの肩にそっと落ちた。それは立ち去っていくあなたに切なさを覚えさせるとともに、この季節に別れを告げるのだった。"

# game/script.rpy:1908
translate japanese chapter_3_88b4d4f8:
    ...
    "葉も落ちた木々に積もった雪が、枝にかかった白い毛布のようにキラキラと輝いている。要塞のごとく堅固なA.S.H.のビルの中にいるにもかかわらず、外の寒さを感じずにはいられない。"

# game/script.rpy:1909
translate japanese chapter_3_8675c14c:
    ...
    "このような環境下で仕事に集中することは、フォークで雪の結晶をを捕まえようとするようなものだ。頭の中は暖かい毛布にくるまってブリトーになることばかり。"

# game/script.rpy:1910
translate japanese chapter_3_aa7cd583:

    # "... Or you can just eat a burrito. "
    "⋯⋯いっそ本物のブリトーを食べるほうがマシかも。"

# game/script.rpy:1913
translate japanese chapter_3_a0cc0aa7:
    ...
    vanta_char "次から次へと、切りのないミッションってマジできついよな⋯⋯休日も出勤ばっかりだし。本当はこの書類を早く確認しなきゃいけないのに、もう何時間もここに座ったまま……よしっ、気分転換に外の空気でも吸ってくるか。"

# game/script.rpy:1916
translate japanese chapter_3_6e27153b:

    # vanta_char "Guys, do you want any drinks? Something to eat? I'm going to grab some snacks real quick."
    vanta_char "俺、ちょっとおやつ買ってくるわ。ついでに何か欲しいもんあるか？"
...
translate japanese chapter_3_d0c13433:
    ...
    "クルーたちは文句を言いながら更に激しく飛び跳ねてた。明らかにあなたの命令に不満を抱いてる。"

# game/script.rpy:1948
translate japanese chapter_3_4e68b5cd:
...
translate japanese chapter_3_d024a46b:
    ...
    "このちっちゃい美味しそうな子たちの世話がこんなにも面倒だなんて想像もしなかった。が、彼らを追い返すこともできない。それ故、あなたはその変えられない事実を渋々受け入れるしかないのだ。"

# game/script.rpy:1964
translate japanese chapter_3_bf991aae:
    ...
    "A.S.H.本部から外に出た途端刺すように冷たい風が顔に吹きつけ、あなたはコートをしっかり体に巻きつける。クルーたちもあなたの胸辺りに身を寄せている――ここは彼らにとっては最高の居場所だ。"

# game/script.rpy:1965
translate japanese chapter_3_26947deb:

    # "You head to the store 'Le Petit Coin' just around the corner, which translates to 'the little corner'."
    "あなたは角にある「Le Petit Coin」という店に向かう――「Le Petit Coin」は「ちいさな角」を意味する。"

# game/script.rpy:1967
translate japanese chapter_3_bd9e931a:

    # vanta_char "Let's see, I'll need to get... A cheesecake for Wilson, a croissant, something sweet... And what else..."
    vanta_char "えーっと、必要なのは⋯⋯ウィルソンのチーズケーキと、クロワッサンと甘いもの⋯⋯あとは⋯⋯"

# game/script.rpy:1978
translate japanese win_cho_one1_accepted_d452cefa:
    ...
    "店の中に入ったあなたは店内の暖かさに包まれている。煌めく灯りや柊のリースといったクリスマスの装飾が至る所に施されており、店全体が陽気で明るい雰囲気に満ちていた。"

# game/script.rpy:1979
translate japanese win_cho_one1_accepted_18a4e7c3:

    # "You can't help but smile as you take in the merry atmosphere. With a sense of excitement, you begin to browse the aisles."
    "その雰囲気にあなたは思わず笑みが溢れ、ワクワクしながら店内を見始める。"

# game/script.rpy:1981
translate japanese win_cho_one1_accepted_39c29576:

    # vanta_char "Oh? There are some samples over there. I'm gonna try it! Oh my god, Zali is gonna hate these."
    vanta_char "おっ？試食コーナーがある！少し食べてみよう――ああ、これザリは嫌がりそうなやつだ。"

# game/script.rpy:1982
translate japanese win_cho_one1_accepted_0b9bc450:
    ...
    "どうやらこれは――この茄子型ペロペロキャンディーはLe Petit Coin のクリスマス新商品だそうだ。一口食べたら結構いい味だった。甘いグレープ風味がしている。"

# game/script.rpy:1983
translate japanese win_cho_one1_accepted_f69a0b93:

    # "You decide to grab a bag for Zali, thinking maybe, just maybe, it might change his perception of eggplant."
    "あなたはこのキャンディーをザリに一袋買っていくことにした。もしや、もしかしたら――茄子に対する彼の認識が変わるかもしれない。"

# game/script.rpy:1986
translate japanese win_cho_one1_accepted_e0d1141a:

    # vanta_char "Is that ice cream cake? I must get it for Wilson. Ahahaha!"
    vanta_char "あれはアイスクリームケーキ？絶対ウィルソンに買ってあげなきゃ！アハハハ！"

# game/script.rpy:1987
translate japanese win_cho_one1_accepted_1ec559e0:

    # vanta_char "I should also get something for myself to drink. Hmm, how about some diet soda?"
    vanta_char "自分にも何か飲み物を買うか。んー、じゃあダイエットサイダーにするか。"

# game/script.rpy:2009
translate japanese win_cho_one1_accepted_d61abc25:
...
translate japanese win_cho_one1_accepted_f046519b:
    ...
    "本能に突き動かされたあなたは躊躇なく前に突っ込んでいき、今にも倒れそうなツリーの前に立ちふさがった。"

# game/script.rpy:2029
translate japanese win_cho_one1_accepted_003738f4:

    # "You manage to steady the swaying tree, preventing it from toppling over completely."
    "傾いたツリーが倒れる直前、あなたは背中にその重みを感じ、見事にツリーを受け止めた。"

# game/script.rpy:2030
translate japanese win_cho_one1_accepted_e52a6bb8:

    # vanta_char "{size=40}Wo-woah!! Woah!!{/size} That was close!"
    vanta_char "{size=40}おっとっと{/size}、危なかった！！"

# game/script.rpy:2031
translate japanese win_cho_one1_accepted_270e3f7d:

    # vanta_char "You are banned from getting under the Christmas tree again. That was insane guys!"
    vanta_char "もうツリーの下に行くのは禁止だ！全くもう。"

# game/script.rpy:2033
translate japanese win_cho_one1_accepted_4c126de5:
    ...
    "クルーたちはツリーを固定させ、最悪の事態を回避してくれたあなたの俊敏さにとても感激していた。あなたたちはこの意外なハプニングにうっかり笑ってしまった。"

# game/script.rpy:2056
translate japanese win_cho_one1_accepted_e484d93e:

    # "You take a selfie with the twinkling Christmas tree; the Crew sound annoyed that they aren't in the picture with you."
    "あなたはクリスマスツリーの前で自撮りをした。クルーたちはあなたと一緒に写ってないことに苛立っているようだ。"

# game/script.rpy:2058
translate japanese win_cho_one1_accepted_deef5302:

    # vanta_char "Haha, I'm joking. I'll take one more with you guys in it."
    vanta_char "ハハ、冗談だよ。今度はみんなもちゃんと写すから、もう一枚。"

# game/script.rpy:2062
translate japanese win_cho_one1_accepted_6d8df2fd:

    # "The second picture seems to make them happier."
    "二枚目の写真のおかげで彼らの機嫌は直ったようだ。"

# game/script.rpy:2071
translate japanese win_cho2p_accepted_fb1c5c0e:

    # "You make your way to the counter to pay. After packing everything, you exit Le Petit Coin."
    "あなたはカウンターに向かい会計を済ませ、買い物袋に商品を詰めLe Petit Coin から出た。"

# game/script.rpy:2077
translate japanese win_cho2p_accepted_be24cf24:

    # "As you head back to A.S.H., you walk past a nearby park..."
    "A.S.H.に帰る途中、あなたは近くの公園を通りかかる。"

# game/script.rpy:2078
translate japanese win_cho2p_accepted_69777107:
    ...
    "雪は既に遊び場をうっすらと覆い始めているが、まだ覆われていない色鮮やかな小山があることにあなたは気づく。"

# game/script.rpy:2079
translate japanese win_cho2p_accepted_25bad656:

    # "Upon closer inspection, you notice that the colors are those of the coat of a little boy, crouched in the snow."
    "よく見ると、その小山は色鮮やかなコートを着た小さな男の子で、雪の中にしゃがんでいたのだった。"

# game/script.rpy:2082
translate japanese win_cho2p_accepted_a972c826:

    # vanta_char "I wonder where his parents are. It's freezing out; let's go see if he's alright."
    vanta_char "彼の両親はどこにいるんだ。こんなに寒い中……一旦様子を見に行こう。"

# game/script.rpy:2087
translate japanese win_cho2p_accepted_d6d56fc1:
    ...
    "クルーたちも男の子のことを心配しているようだ。一匹のクルーがコートから抜け出し、男の子の無事を確かめようとあなたの前を飛び跳ねる。"

# game/script.rpy:2095
translate japanese win_cho_one2_accepted_7e06aab1:

    # vanta_char "Hey kiddo, what are you doing here by yourself? Where's your family?"
    vanta_char "やあ君、一人で何をしているんだい？ご家族は？"

# game/script.rpy:2096
translate japanese win_cho_one2_accepted_777f3340:

    # "You must seem tall and intimidating to him, which makes him a bit scared to speak."
    "あなたは背が高く威圧的な外見をしているため、男の子は少し恐怖を感じ声が出せずにいた。"

# game/script.rpy:2100
translate japanese win_cho_one2_accepted_5c082e3b:

    # "You look at the Vantacrew, and you have an idea!"
    "ベンタクルーたちを見て、あなたはいいことを思いついた。"

# game/script.rpy:2105
translate japanese win_cho_one2_accepted_e2752b1a:

    # vandc_char "{size=60}:3{/size}"
    vandc_char "{size=60}:3{/size}"

# game/script.rpy:2106
translate japanese win_cho_one2_accepted_61c79302:

    # "The boy looks confused, clearly unsure of what's going on."
    "男の子はとても困惑した様子で、何が起こっているのかさっぱりわからないようだ。"

# game/script.rpy:2111
translate japanese win_cho_one2_accepted_e7ad6f95:

    # vanta_char "No reaction? Really? Okay, that wasn't my best shot, let's try again!"
    vanta_char "反応なし？マジ？これはまだ全力じゃないんだ。もっかい行くぞ！ほら！"

# game/script.rpy:2117
translate japanese win_cho_one2_accepted_96f0d7b3:

    # vandc_char "{size=100}:3{/size}"
    vandc_char "{size=100}:3{/size}"

# game/script.rpy:2118
translate japanese win_cho_one2_accepted_4104e2f9:

    # "The kid finally smiles, bringing a sense of relief to both you and the Vantacrew."
    "男の子はやっと笑ってくれた。その笑顔を見て、あなたもベンタクルーも少し安心した。"

# game/script.rpy:2123
translate japanese win_cho_one2_accepted_4de6fbbc:
    ...
    npc5_char "ぼく⋯⋯友だちと毎日この公園で遊んでいるんだ。でも彼女は家族と一緒に別の町に引っ越すことになって、それでぼくたち昨日ケンカをしちゃったんだ。だから彼女は今日はここに来なかったんだ⋯⋯。"

# game/script.rpy:2124
translate japanese win_cho_one2_accepted_423d7ca3:
    ...
    npc5_char "ケンカしなければ良かった。彼女はお気に入りの、とてもとても大切にしているゲームを貸してくれたのに、ぼくのせいで彼女に返すことが出来なくなっちゃった。"

# game/script.rpy:2125
translate japanese win_cho_one2_accepted_58bc3018:
    ...
    "彼がゲームをしっかりと手にしているのに気づく。カバーに描かれた見覚えのある青いスライムが、あなたにベンタクルーたちを思い出させる。そっと振り返ると、背後の雪の中でクルーたちが飛び跳ねている姿が見えた。"

# game/script.rpy:2128
translate japanese win_cho_one2_accepted_51855245:
    ...
    vanta_char "君、よく聞け。もしその友達が君にとってめっちゃくちゃ大切な存在だったら、ここで待つだけじゃなく、彼女のところに行くべきだ。"

# game/script.rpy:2129
translate japanese win_cho_one2_accepted_20fcb3a8:
    ...
    npc5_char "でも⋯⋯でも⋯⋯彼女を困らせちゃわないかな？もし彼女がぼくに会いたくなかったら？もう友だちでいたくないって思われたらどうしよう。"

# game/script.rpy:2130
translate japanese win_cho_one2_accepted_fa82437a:
    ...
    vanta_char "あんまり考えすぎるな。自分にできることを最後までやりきるんだ。大切な人に自分の気持ちを伝えることを恐れるな。わかったか？"

# game/script.rpy:2135
translate japanese win_cho_one2_accepted_85742131:
    ...
    "その励ましもあり、男の子はあなたに友達の家まで付き添ってほしいと頼んだ。しかし彼女はすでに引っ越しており、ただ家は空き家になっていた。"

# game/script.rpy:2136
translate japanese win_cho_one2_accepted_12683346:
    ...
    "あなたは泣き出してしまった男の子を慰めながら周りを見回した。ついさっきまであなたの後をついて来ていたクルーたちが何故か消えていた。"

# game/script.rpy:2137
translate japanese win_cho_one2_accepted_1fb31e34:

    # "Immediately, you implore Kurococco to track the Crew's location. The results reveal that they are in a moving vehicle."
    "あなたはすぐにクルーたちの居場所を追跡するようクロコッコに頼んだ。その結果、彼らは移動中の車の中にいることが判明した。"

# game/script.rpy:2138
translate japanese win_cho_one2_accepted_168132a1:
    ...
    vanta_char "少年、準備はいいか？しっかりつかまってな。俺たちの冒険が始まるぞ！すっごいスピードでダッシュするから、空を飛んでるような感覚になるかもしれないが実はただ走ってるだけ。わかったか？"

# game/script.rpy:2154
translate japanese win_cho_one2_accepted_567a216f:
    ...
    "ヒーローとして経験豊富なあなたにとって、買い物袋を持ちながら男の子を背負うなど造作もない。"

# game/script.rpy:2156
translate japanese win_cho_one2_accepted_b29ef40f:

    # "You leap into action, showing off your parkour prowess."
    "あなたは優れたパルクールの腕前を披露した。"

# game/script.rpy:2157
translate japanese win_cho_one2_accepted_5fdc9dca:

    # npc5_char "{size=45}WOW!! YOU'RE SO COOL!{/size}\nAre you Arachnid-Man? Oh, but... you're not wearing tights."
    npc5_char "{size=45}すっげぇ！かっけぇー！！{/size}\nお兄ちゃんもしかしてスパイダーガイなの？あ、でも⋯⋯タイツ穿いてないね。"

# game/script.rpy:2160
translate japanese win_cho_one2_accepted_7d099ef4:
    ...
    vanta_char "スパイダーガイなんかじゃない！俺は暴君！Krisisのヒーローだ！\nまぁ仲間の一人は確かにタイツを穿いてるけど、全てのヒーローがそういうわけじゃないからな！"

# game/script.rpy:2164
translate japanese win_cho_one2_accepted_302e0036:

    # "As you catch up to the moving car, its speed gradually decreases until it eventually comes to a stop in front of a house."
    "走っている車に追いついたタイミングで速度が徐々に落ち、とある民家の前で止まった。"

# game/script.rpy:2168
translate japanese win_cho_one2_accepted_678d401d:
    ...
    "車のドアが開き、中から小さな女の子とその両親が降りてくる。それに続くようにベンタクルーたちもこっそりと降りてくる。"

# game/script.rpy:2172
translate japanese win_cho_one2_accepted_3ee21456:

    # npc5_char "Oh! That...that's my friend..."
    npc5_char "あっ、あれは⋯⋯ぼくの友だちだ⋯⋯"

# game/script.rpy:2175
translate japanese win_cho_one2_accepted_039d5761:

    # vanta_char "Wait, really? LMAO? How did the Crew know...?"
    vanta_char "えっマジ？どうやってわかったんだあいつら⋯⋯？"

# game/script.rpy:2179
translate japanese win_cho_one2_accepted_154e2f10:
    ...
    "あなたはその跳ねるスライムたちを見ていると、あの :3 の顔の裏には絶対何も考えていないと思わずにはいられない。きっと頭は空っぽで楽しんでいただけに違いない！"

# game/script.rpy:2180
translate japanese win_cho_one2_accepted_c018bf01:

    # "Well, at least it all worked out, just like in a Christmas movie."
    "まぁ、とにかく全てがうまくいって良かった。もはやクリスマス映画だ。"

# game/script.rpy:2183
translate japanese win_cho_one2_accepted_50e2a3ba:

    # "With a smile, you hand the boy the game he wishes to return and give him a reassuring push towards his friend's house."
    "あなたは微笑みながら男の子に例のゲームを手渡し、彼の背中を優しく押して友達の家へ向かわせた。"

# game/script.rpy:2184
translate japanese win_cho_one2_accepted_f46478c9:

    # vanta_char "Come on, I believe in you. Go ahead and tell her how you feel."
    vanta_char "俺は君を信じているよ。さあ行って、彼女に気持ちを伝えてきな。"

# game/script.rpy:2185
translate japanese win_cho_one2_accepted_852fedc7:

    # "The boy mustered up the courage to step forward and say hello to his friend."
    "男の子は勇気をもって踏み出し、友だちに声をかける。"

# game/script.rpy:2189
translate japanese win_cho_one2_accepted_d4213574:
    ...
    npc5_char "やあ⋯⋯あのね、昨日のこと、本当にごめん。\nまだ君と友だちでいたいし、君の好きなゲームをまた一緒にやりたいんだ。"

# game/script.rpy:2190
translate japanese win_cho_one2_accepted_71beb13b:

    # npc6_char "What? Of course we're still friends! I just thought we'd meet up again so I could get it back when you finish—"
    npc6_char "何言ってるの？私たちはずっと友達でしょ！また会えるんだし、君がプレイし終わったらまた返してもらおうと――"

# game/script.rpy:2194
translate japanese win_cho_one2_accepted_ec42807c:
    ...
    npc6_char "って、何でスライムがこんなにたくさんいるの？後ろにいるあの人は誰？もしあの人が何かしようとしてきたら私が守ってあげる！"

# game/script.rpy:2195
translate japanese win_cho_one2_accepted_41134a3f:

    # npc5_char "Oh, that guy! Um, apparently, he's a hero, even though he's not wearing tights... I think! He brought me here."
    npc5_char "あっ、あの人ね！えーっと、どうやらヒーローらしいよ。タイツは穿いてないけど⋯⋯まぁ、間違いないと思う！ぼくをここに連れてきたのはあの人なんだ。"

# game/script.rpy:2196
translate japanese win_cho_one2_accepted_5e7e2b98:
    ...
    "男の子は友達との再会にとても喜んだ。彼女の両親に囲まれた彼らはあなたに別れを告げ、そして女の子の新しい家に入っていった。"

# game/script.rpy:2202
translate japanese win_cho_one2_accepted_d3e78510:
...
translate japanese win_cho_one2_accepted_4a9d9903:
    ...
    vanta_char "いいね。すぐ帰るよ。"

# game/script.rpy:2245
translate japanese win_cho_one2_accepted_42bfde4c:

    # zali_char "Hmm... Then I think I can make some macarons for dessert!"
    zali_char "じゃあ⋯⋯〆のデザートに私がマカロンを作ろうかな？"

# game/script.rpy:2250
translate japanese win_cho_one2_accepted_619de4d5:

    # wandv_char "{size=50}Please don't!{/size}"
    wandv_char "すいません勘弁してください！"

# game/script.rpy:2257
translate japanese win_cho_one2_accepted_9f64c05d:
    ...
    "あなたは電話を切り、ベンタクルーたちはいないかと周りを見回した。するとあなたの足元に寄り添って暖かさを求めてる子もいれば、路上の雪ではしゃいでる子もいる。"

# game/script.rpy:2260
translate japanese win_cho_one2_accepted_3903b6de:

    # vanta_char "Come on, let's go home, my Crew."
    vanta_char "ほら、俺のクルーたち。家に帰ろう。"

# game/script.rpy:2263
translate japanese win_cho_one2_accepted_e8359f38:

    # vanta_char "{size=50}Ha...Merry Krisis!{/size}"
    vanta_char "{size=50}はぁ⋯⋯Merry Krisis！{/size}"

# game/script.rpy:2267
translate japanese win_cho_one2_accepted_1ff2dba8:
    ...
    "コートの前を広げると、クルーたちは自然と飛び込んできてあなたに寄り添う。凍てつくような季節だが温かい気持ちがあなたを包み込み、思わず笑みが溢れた。"

# game/script.rpy:2319
translate japanese chapter_4_f6558872:

    # "Ah, spring—a time of longer days, warmer sunshine, and, unfortunately, the return of hay fever."
    "ああ、春が来た――日差しが暖かくなり、陽ものび始め、そして残念なことに花粉症が再発する季節だ。"
...
translate japanese chapter_4_6ff8b1a4:

    # zali_char "Vanta! Good morning! Isn't it just lovely...spring!"
    zali_char "ベンタ！おはようー春っていい季節だね！"
...
translate japanese chapter_4_8e4bebd0:
    ...
    "突然、誰かがドアを開けた。入ってきたのはユウ・Ｑ・ウィルソン――まだ眠そうなウィルソニアーズたちが彼の後ろについてきている。"

# game/script.rpy:2339
translate japanese chapter_4_146b43d3:

    # wilson_char "WITHOUT ME? I want to go see the cherry blossoms too!"
    wilson_char "僕も！僕も行きたい！"

# game/script.rpy:2340
translate japanese chapter_4_0488eba8:

    # vandz_char "Good morning, Wilson!"
    vandz_char "おはよう、ウィルソン！"
...
translate japanese chapter_4_15d98763:
    ...
    wilson_char "ベンタ、これは何なんだ⋯⋯？"

# game/script.rpy:2405
translate japanese chapter_4_ed1ebdd4:
    ...
    vanta_char "聞いてくれ。これを見た瞬間、お前のことがぱっと頭に浮かんだんだ。コーヒーに入れるのにちょうどいい甘さだ。感謝してくれてもいいんだぜ。"

# game/script.rpy:2408
translate japanese chapter_4_bd0fd5a7:

    # wilson_char "Whatever dude, get this out of my face."
    wilson_char "はいはい。さっさとこれを持ってあっち行ってよ。"

# game/script.rpy:2409
translate japanese chapter_4_ab08fb4a:

    # "Going to the fridge himself, Wilson looks around and finds the unopened maple syrup from a couple of months ago."
    "ウィルソンは自分で冷蔵庫を開け物色すると、数ヶ月前にもらって未開封のままのメープルシロップを見つけた。"
...
translate japanese chapter_4_6dd76647:
    ...
    "あなたはウィルソンの反応に爆笑する。彼はブツブツ文句を言った後、黙ってコーヒーを淹れに行った。"

# game/script.rpy:2423
translate japanese chapter_4_8304a501:
    ...
    "アイスクリームケーキを手に取りたい誘惑に駆られながらも、あなたは良きチームメイトとしてメープルシロップを手に取ることにした。 冷蔵庫を閉め、ウィルソンにボトルを渡す。"

# game/script.rpy:2424
translate japanese chapter_4_717c1dac:
...
translate japanese chapter_4_ddf99ce4:
...
translate japanese spr_cho2_1_accepted_c754576d:
    ...
    "ザリとウィルソン、そしてあなたは普段よく行く地元のパン屋のウェブサイトを見始めた。パン菓子を見ていたあなたの横で、ザリが期待に満ちた目でじっとクロワッサンを見つめていた。"

# game/script.rpy:2446
translate japanese spr_cho2_1_accepted_b7c471dd:

    # vanta_char "See something you like, Zali?"
    vanta_char "何か食べたいものが見つかったか？ザリ。"
...
translate japanese spr_cho2_1_accepted_b75f1ee3:
    ...
    zali_char "ベンタ、二度とそんな冗談を言わないでくれ。私の心臓が持たないよ。全然そういうふうには見えないよ私は。なんてことを……。"

# game/script.rpy:2456
translate japanese spr_cho2_1_accepted_21dd6a26:

    # "In the end, you all order what you usually get."
    "此句刪除"

# game/script.rpy:2460
translate japanese spr_cho2_1_accepted_0007e983:

    # "You let out a chuckle as you hold your hands up in defeat. Your attention shifts towards your desk."
    "あなたは両手を上げ、参ったと苦笑する。結局あなたたちは全員いつもと同じものを注文していた。"

# game/script.rpy:2463
translate japanese spr_cho2_1_accepted_f2f8eeb1:
...
translate japanese spr_cho2_1_accepted_13d7e455:
...
translate japanese spr_cho2_1_accepted_a187cd7e:
    ...
    "もう一つはクロワッサンのストラップ。これを見るとついザリのことを思い出す。よく考えた結果、あなたはザリに――"

# game/script.rpy:2472
translate japanese spr_cho2_1_accepted_48601bc2:
...
translate japanese spr_cho2_1_accepted_b1728f37:

    # zali_char "Haha, this is cute! Where did you get it?"
    zali_char "ハハ、可愛いね！どこで買ったの？"

# game/script.rpy:2474
translate japanese spr_cho2_1_accepted_3f03d2f6:
...
translate japanese spr_cho2_1_accepted_034d5059:

    # zali_char "Better now than never, right?"
    zali_char "やらないよりはやったほうがいい。でしょ？"

# game/script.rpy:2476
translate japanese spr_cho2_1_accepted_4431e93e:
    ...
    "ザリは微笑み、あなたがくれたプレゼントをとても喜んだ。その反応にあなたの胸は喜びで膨らんだ。ようやく彼にプレゼントを渡すことができて本当に良かった。"

# game/script.rpy:2496
translate japanese spr_cho2_1_accepted_65b3e31c:

    # vanta_char "Have some candy to hold you over. Our order should be here soon!"
    vanta_char "先にキャンディーを食べよう。注文したものはもうすぐ届くはずだ。"

# game/script.rpy:2499
translate japanese spr_cho2_1_accepted_dfbddcc1:

    # zali_char "Ah, thank you! Wait, why is this in the shape of an eggplant?"
    zali_char "おっ、ありがとう！って待って、何で茄子型なの？"

# game/script.rpy:2500
translate japanese spr_cho2_1_accepted_d94b8dd4:
...
translate japanese spr_cho2_1_accepted_414d2045:
    ...
    "あなたはキャンディーをザリのほうに投げ、彼はしっかりそれを受け取った。ザリはためらいがちに袋を開け慎重に匂いを嗅いでから、目を細めてあなたのほうを見た。あなたは彼に安心して、と親指を立てた。"

# game/script.rpy:2504
translate japanese spr_cho2_1_accepted_5b4bd9fd:
    ...
    "ザリは恐る恐るキャンディーを口に入れる。そして驚いて目を開き、小さな笑みを顔に浮かべた。"
...
translate japanese spr_cho2_1_accepted_b60d58c0:
    ...
    wilson_char "ちょっと、僕も食べたい。"

# game/script.rpy:2513
translate japanese spr_cho2_1_accepted_ad948029:

    # vanta_char "Go right ahead, there's plenty more where that came from!"
    vanta_char "ほら、まだまだあるぞ！"
...
translate japanese spr_cho2_2_accepted_44e98921:
    ...
    "出前を待つ間、あなたたちはいつでもミッションを果たせるようにヒーロースーツに着替えた。"

# game/script.rpy:2527
translate japanese spr_cho2_2_accepted_21766bb0:

    # "A buzzing sound can be heard from the door. You head over and open it, revealing the breakfast order you made in advance."
    "チャイムが鳴った。あなたは玄関に向かいドアを開ける。さっき注文した朝ごはんがやっと届いた。"

# game/script.rpy:2528
translate japanese spr_cho2_2_accepted_e9b5c566:

    # "You check the contents of the bag, making sure everything is there and correct."
    "あなたは不足はないかとバッグの中身をしっかり確認する。"

# game/script.rpy:2531
translate japanese spr_cho2_2_accepted_d893c5b4:

    # vanta_char "Guys, our order's here!"
    vanta_char "二人とも、朝ごはんが届いたぞ！"

# game/script.rpy:2533
translate japanese spr_cho2_2_accepted_1ca2a4aa:

    # wilson_char "Yay! I need food right now!"
    wilson_char "わーい！早速食べよう！"

# game/script.rpy:2535
translate japanese spr_cho2_2_accepted_38fbcd15:

    # zali_char "Yay!! Bon appetit!"
    zali_char "やった！いただきます！"

# game/script.rpy:2543
translate japanese spr_cho2_2_accepted_993074ad:
    ...
    "朝食にコーヒーとクロワッサンを堪能する三人。最後の一口を食べたところで、あなたたち全員のデバイスが一斉に鳴った。"

# game/script.rpy:2545
translate japanese spr_cho2_2_accepted_a6cde219:

    # "You pull out your phone to find a new mission notification. The three of you read the brief together."
    "あなたは自分のデバイスを取り出し、新しいミッションの通知を受け取った。そして三人で一緒に概要を読む。"

# game/script.rpy:2546
translate japanese spr_cho2_2_accepted_b494fd56:
    ...
    zali_char "『ベンタクロウが解決したミッションで浮上した製薬会社について、重要な手がかりを手に入れました。』"
...
translate japanese spr_cho2_2_accepted_edbdb4c3:
    ...
    vanta_char "あっそうだ！あのクソでかいタコと怪しいドリンク。それがなんだって？"

# game/script.rpy:2551
translate japanese spr_cho2_2_accepted_0ba65693:
    ...
    zali_char "『A.S.H.の情報システム部門が、その会社の不正を隠蔽するために使われていたと思われる場所を発見した。Krisisにはそこに潜入し、関連性のあるデータを回収してもらいたい。』"

# game/script.rpy:2552
translate japanese spr_cho2_2_accepted_99616a69:
    ...
    wilson_char "『今回の作戦は一切の巻き添え被害を避けるため慎重に実施される。よって、A.S.H.のＡ班は近くに配置され、一般市民にとって危険と思われる脅威を無力化するためにいつでも介入できるよう待機する。』"

# game/script.rpy:2553
translate japanese spr_cho2_2_accepted_832423c2:
    ...
    wilson_char "『不測の事態を避けるため、ヴェズキッツ、ウィルソニアーズ、そしてベンタクルーが必要な支援をいつでも提供できるよう待機します。』"

# game/script.rpy:2554
translate japanese spr_cho2_2_accepted_727bce15:

    # vanta_char "Wait, you mean Squad A, the demolitions team? Are they really going to be on standby?"
    vanta_char "待ってくれ、A班ってあの解体チームってことだろ？本当に待機してくれるのか？"

# game/script.rpy:2557
translate japanese spr_cho2_2_accepted_2e3cbdaa:

    # wilson_char "Looks like it's happening. Alright, boys, let's gear up and get ready to roll."
    wilson_char "概要によると間違いないみたいだね。よしっみんな、出発の準備を整えよう。"

# game/script.rpy:2563
translate japanese spr_cho2_2_accepted_78c56a2c:
    ...
    "ミッションに備えることは、あなたたちにとってはもはや呼吸をするに等しい。道具を手に取り、最後までしっかり整える。あなたたちが信頼できる相棒――ツチ、テンタポッド、そしてクロコッコも全員準備万端だ。"

# game/script.rpy:2571
translate japanese spr_cho2_2_accepted_30ad8559:
    ...
    "あなたは概要で指定された場所に到着した。静かに建物へ潜入し、調査すべきものはないかと目を光らせる。"

# game/script.rpy:2574
translate japanese spr_cho2_2_accepted_f1bb5e72:
    ...
    "ザリ、ウィルソン、そしてあなたは、非の打ち所がない仕事振りを見せている。簡単なジェスチャーで、相手の言いたいことを確実に把握することができる。"

# game/script.rpy:2575
translate japanese spr_cho2_2_accepted_e9fd1af3:

    # vanta_char "Pssst... This way. "
    vanta_char "おい、こっち。"

# game/script.rpy:2576
translate japanese spr_cho2_2_accepted_4a58fca7:

    # zali_char "Oh my goodness... What are these?"
    zali_char "うわぁ、これは一体何なんだ？"

# game/script.rpy:2580
translate japanese spr_cho2_2_accepted_9a6cde42:

    # wilson_char "Oh... My... God..."
    wilson_char "や、や⋯⋯ば⋯⋯い⋯⋯。"

# game/script.rpy:2583
translate japanese spr_cho2_2_accepted_f05beef7:

    # wilson_char "These mushrooms... There are so many of them. How long have they been planning this?"
    wilson_char "マッシュルームが⋯⋯マッシュルームが多すぎ⋯⋯いつからこんなことを計画してたんだろう。"

# game/script.rpy:2584
translate japanese spr_cho2_2_accepted_55cfb7b3:
    ...
    zali_char "待って、これって前に村で収穫を手伝った時に食べたマッシュルームじゃない？あとあれ、ありえないほど獰猛なクマにも遭遇したよね？"

# game/script.rpy:2585
translate japanese spr_cho2_2_accepted_bd995243:
    ...
    vanta_char "あっ、この匂い！思い出した！この匂いってタコと戦った時に飲んだドリンクと同じだ。どうりで妙な懐かしさがあったわけだ。"
...
translate japanese spr_cho2_2_accepted_d8b79c38:
    ...
    wilson_char "ねぇねぇねぇ、何か聞こえない？何の音だ？どっから音がしてるんだ？"

# game/script.rpy:2595
translate japanese spr_cho2_2_accepted_7f33184c:

    # zali_char "I heard it too. Sounds like something metallic dropped onto the floor..."
    zali_char "聞こえたね。何か金属製品みたいなものが床に落ちたような音⋯⋯。"

# game/script.rpy:2598
translate japanese spr_cho2_2_accepted_7013b0dd:

    # "You look around the lab, noticing a door behind the shelves. The noises seem to come from there."
    "あなたは研究室の周りを見渡し、棚の後ろにドアがあることに気づいた。物音はそこから聞こえてくるようだ。"

# game/script.rpy:2599
translate japanese spr_cho2_2_accepted_76c24560:

    # vanta_char "Well, I guess we simply have to ball. Whatever's behind that door could be dangerous."
    vanta_char "危険かもしれないが、このドアの向こうにあるものが何であれやるしかない。"

# game/script.rpy:2600
translate japanese spr_cho2_2_accepted_4af73650:
    ...
    "Krisisの戦車であるあなたはドアの前に立ち、その後ろでザリがサポートすることに。その間、ウィルソンはドアの横にあるパッドロックをチェックしていく。"

# game/script.rpy:2603
translate japanese spr_cho2_2_accepted_3c114074:

    # wilson_char "Are you ready, Vanta?"
    wilson_char "準備はいいか？ベンタ。"
...
translate japanese spr_cho2_2_accepted_b980f046:
    ...
    "重い金属製のドアが僅かなガス抜き音と共にゆっくりと開いていた。中は真っ暗で、あなたは慎重に足を踏み入れ、五感を厳戒態勢にして、この先に何が待ち受けているとしても覚悟はできている。"

# game/script.rpy:2614
translate japanese spr_cho2_2_accepted_177fadea:

    # "You advance toward the source of the noise, with Zali and Wilson trailing a few steps behind you."
    "あなたは先に物音の発生源に向かい、ザリとウィルソンが数歩後ろをついてくる。"

# game/script.rpy:2615
translate japanese spr_cho2_2_accepted_da1a92a4:

    # zali_char "You see anything, Vanta?"
    zali_char "ベンタ、何か見つけたのかい？"

# game/script.rpy:2618
translate japanese spr_cho2_2_accepted_e7168b75:

    # vanta_char "It... It's a fox?"
    vanta_char "き⋯⋯狐？か？"

# game/script.rpy:2619
translate japanese spr_cho2_2_accepted_dd71bfee:
...
translate japanese spr_cho2_2_accepted_3d3a0758:
    ...
    "あなたは近くのテーブルに目をやり、さっきの物音は仔犬が暴れて檻が床に落ちたからだと推測する。"
...
translate japanese spr_cho2_2_accepted_0762c345:
    ...
    wilson_char "男の子か？うん、間違いないね。"

# game/script.rpy:2625
translate japanese spr_cho2_2_accepted_6501f2b6:

    # zali_char "We need to be careful; we don't know if the puppy is already part of an experiment."
    zali_char "気をつけて。この子は実験対象になっている可能性があるんだから。"

# game/script.rpy:2629
translate japanese spr_cho2_2_accepted_aaa212cc:
    ...
    "あなたは檻にかかっている南京錠を無理矢理外した。それに驚き怖がった仔犬は檻の中を縦横無尽に走り回り、大きな声で泣き始める。"

# game/script.rpy:2631
translate japanese spr_cho2_2_accepted_ae0b3749:
    ...
    "あなたはすぐに手を檻の中へ差し入れ、仔犬を腕の中に掬いあげる。不思議なことにあなたの腕に抱かれた瞬間、仔犬はすぐにおとなしくなった。"

# game/script.rpy:2632
translate japanese spr_cho2_2_accepted_11aa33ce:

    # vanta_char "Don't worry, buddy. We'll get you out of here."
    vanta_char "心配するな。必ずここから出してやる。"
...
translate japanese spr_cho2_2_accepted_96883e46:
    ...
    "あなたは仔犬をよく観察する。赤柴の男の子で、おそらく生後２〜３ヶ月と思われる。"

# game/script.rpy:2635
translate japanese spr_cho2_2_accepted_182aa4f6:
    ...
    "ただ、彼の足先はソックスを履いているように真っ白で、お腹も白い毛が生えている。逆に尻尾の先が少し黒い。それ故、一見する狐と間違えるのも無理はない。"
...
translate japanese spr_cho2_2_accepted_c6793137:
    ...
    zali_char "だから彼らはその結果を他の動物にも再現しようとしていた。このコはその被験体みたい。"

# game/script.rpy:2641
translate japanese spr_cho2_2_accepted_7300636f:
    ...
    "ザリはコンピュータに記録されているデータに目を通し、他の目撃者が撮影したタコ事件の切り抜き動画を見つける。ファイルの中には、現在進行中の実験を示すテスト結果も多数ある。"

# game/script.rpy:2642
translate japanese spr_cho2_2_accepted_cab7f21e:

    # "Zali transfers the data from the computer to Tsuchi's cloud system, ensuring it reaches A.S.H.'s intel department promptly."
    "ザリはコンピュータからツチのクラウドシステムにデータを転送し、A.S.H.の情報システム部門に速やかに送った。"

# game/script.rpy:2643
translate japanese spr_cho2_2_accepted_92f40d7f:
    ...
    wilson_char "軽度の摂取は暴走や過度の興奮を引き起こす。また摂取量を増やすと、身体能力に大きな変化をもたらす可能性もある⋯⋯と。"
...
translate japanese spr_cho2_2_accepted_27c3e2b0:
    ...
    vanta_char "飲んだは飲んだけど、何も感じなかった。そもそも俺はそんなにヤワな人間じゃない。"
...
translate japanese spr_cho2_2_accepted_a0a42e50:
    ...
    vanta_char "まあキノコは低カロリーだからな⋯⋯でも、もし本当にそうだとしたら、俺の体にも変異が起きるはずだよな？"

# game/script.rpy:2650
translate japanese spr_cho2_2_accepted_ff01d79b:

    # zali_char "Hmm, here's my theory... Perhaps your body simply reacted differently, and the substance didn't affect you."
    zali_char "うーん、これはあくまで私の仮説なんだけど⋯⋯おそらく、君の体は特殊で、通常とは異なる反応が起きてあまり影響がなかったんじゃないかな。"

# game/script.rpy:2651
translate japanese spr_cho2_2_accepted_e1b43784:
    ...
    zali_char "それにA.S.H.に入ってから、君もいくつかの試練やテストに参加してきた。元々私の実験台でもあるし⋯⋯それで耐性ができて影響を受けなかったのかもしれない。"
...
translate japanese spr_cho2_2_accepted_2a0a3be5:
    ...
    wilson_char "もしかしたら背が伸びて、強くなって、イケメンになっていたかもしれないじゃん！"

# game/script.rpy:2654
translate japanese spr_cho2_2_accepted_21e2cb79:

    # "You and Zali exchange a knowing glance, silently agreeing to let Wilson continue living in his delusion."
    "あなたとザリは無言でお互いの顔を見合わせ、ウィルソンが妄想にふけっている様子を見守ることにした。"

# game/script.rpy:2657
translate japanese spr_cho2_2_accepted_0053f173:
    ...
    "仔犬はあなたの腕の中にすっぽりと収まり、とても心地よさそうにしている。あなたが仔犬を顔に近づけると、仔犬は満面の笑みであなたを見つめる。あなたはその笑顔で何とも言えない喜びでいっぱいになる。"

# game/script.rpy:2658
translate japanese spr_cho2_2_accepted_442e0ca3:

    # "Your nose meets his in a gentle boop as you gaze into his big, round, black eyes."
    "あなたは彼の大きくて丸い黒い目を見つめながら、自分の鼻が彼の鼻に優しく触れた。"
...
translate japanese spr_cho2_2_accepted_a03d5a34:
    ...
    "その言葉に対して、仔犬は大きなあくびをして、掌をあなたの顔に当てる。"

# game/script.rpy:2666
translate japanese spr_cho2_2_accepted_8f6cf460:

    # zandw_char "Hahahahahaha!"
    zandw_char "ハハハハハハハハ！"

# game/script.rpy:2682
translate japanese spr_cho2_2_accepted_f74e8857:

    # vanta_char "Okay, now here's the question..."
    vanta_char "さて、ここからが問題だ。"
...
translate japanese spr_cho2_2_accepted_4f5c1d62:
    ...
    wilson_char "それじゃみんな！準備はいいかい？"

# game/script.rpy:2690
translate japanese spr_cho2_2_accepted_12c6d8c5:
    ...
    "ウィルソンの合図であなたは動き出し、火災報知器を作動させる。けたたましいサイレンの音がビル全体に響き渡り、緊迫感で満たされる。"

# game/script.rpy:2692
translate japanese spr_cho2_2_accepted_2cb83266:
    ...
    "その瞬間、各部屋で光る真紅の照明が即時避難の必要性を示し、人々は速やかにビルから避難し始める。"
...
translate japanese spr_cho2_2_accepted_a9a03b23:
    ...
    wilson_char "機密データの回収を達成し、ビルから退避する。"

# game/script.rpy:2696
translate japanese spr_cho2_2_accepted_41142d02:

    # wilson_char "{size=35}ETA on our exit: 4 minutes, 20 seconds.{/size}"
    wilson_char "{size=35}出口までの到着予定時刻は４分２０秒。{/size}"

# game/script.rpy:2697
translate japanese spr_cho2_2_accepted_b5538df4:

    # wilson_char "You are clear to initiate building demolition at the same time. Over."
    wilson_char "当該ビルの破壊は許可済みです。どうぞ。"

# game/script.rpy:2698
translate japanese spr_cho2_2_accepted_43072d85:

    # vanta_char "{size=35}Let's move out! Follow me!{/size}"
    vanta_char "{size=35}ほら行くぞ！ついてこい！{/size}"
...
translate japanese spr_cho2_2_accepted_aab86b20:
    ...
    zali_char "{size=35}もう時間がない。行こう。{/size}"
...
translate japanese spr_cho2_2_accepted_f1a9a896:
    ...
    "衝撃波が押し寄せてきた時､あなたはふと背中に固定されている仔犬を思い出した。反射的に体を捻り、強烈な爆風から仔犬を庇う。"

# game/script.rpy:2717
translate japanese spr_cho2_2_accepted_a09152e3:

    # "Smoke rises into the sky as the once-standing building structure becomes rubble in a matter of seconds."
    "煙が空に立ち上がり、かつては建っていたビルが一瞬で瓦礫と化す。"

# game/script.rpy:2721
translate japanese spr_cho2_2_accepted_e00d691f:

    # zandw_char "{size=50}VANTA!!!{/size}"
    zandw_char "{size=50}ベンタ！！！{/size}"

# game/script.rpy:2722
translate japanese spr_cho2_2_accepted_25183c97:

    # "Your body is propelled backward by the force of the explosion, sending you plummeting towards the ground."
    "爆発の勢いで、あなたの体が後方に押し出され、地面に叩き付けられそうになる。"

# game/script.rpy:2723
translate japanese spr_cho2_2_accepted_2d17d265:

    # zandw_char "{size=50}Arghhhhhh!!!{/size}"
    zandw_char "{size=50}うおおおおおおお！！！{/size}"

# game/script.rpy:2726
translate japanese spr_cho2_2_accepted_d35c8fc1:
    ...
    "ザリがあなたの胸のハーネスを引っ張り、あなたの体を自分のほうに引き寄せる。一方、ウィルソンは電光石火の速さで突進し、あなたの肩を支えながら仔犬を守る。"

# game/script.rpy:2727
translate japanese spr_cho2_2_accepted_d5e4f3c2:

    # wilson_char "Whooo! I got him! He's all good!"
    wilson_char "やった！無事生還！"

# game/script.rpy:2728
translate japanese spr_cho2_2_accepted_ace27291:

    # "As the sky clears and the dust settles, the rush of adrenaline causes your heart to race."
    "空が晴れ、砂埃が静まった。アドレナリンの効果がまだ残ってるが、あなたたちの心臓は今なお早鐘を打っている。"

# game/script.rpy:2729
translate japanese spr_cho2_2_accepted_5ad29fbf:

    # zali_char "Phew! Thank goodness for that safety belt thingy, or I wouldn't have been able to grab you in time."
    zali_char "ふぅ！この「安全ベルト」のおかげで助かった。でなければ君を掴み損ねていたよ。"

# game/script.rpy:2730
translate japanese spr_cho2_2_accepted_484b2dc4:

    # vanta_char "... Thanks bro."
    vanta_char "⋯⋯たすかった。"

# game/script.rpy:2733
translate japanese spr_cho2_2_accepted_359213ba:

    # wilson_char "Excusez-moi, guys! Find your footing, or you're going to squash me."
    wilson_char "Excusez-moiーーちょっと！落ち着いてるところ悪いんだけど、早く立ってくれないか？僕が潰されちゃう！"

# game/script.rpy:2734
translate japanese spr_cho2_2_accepted_76256b5e:
    ...
    "ウィルソンの手があなたの後ろで震えているのを感じながら、あなたはきちんと立ち上がる。ザリがあなたのハーネスを握る手をちょっとだけ早く離し、ハーネスがあなたの胸にパチンと音を立てて元のところに戻ってきた。"

# game/script.rpy:2737
translate japanese spr_cho2_2_accepted_2977ae83:

    # vanta_char "{size=45}AHHHHH!!! F—THAT HURTS!!!{/size}"
    vanta_char "{size=45}あぁぁああぁぁあ！！！F――いってぇな！！！{/size}"

# game/script.rpy:2738
translate japanese spr_cho2_2_accepted_2457de46:

    # zali_char "Ah hahah, sorry Vanta!!"
    zali_char "あっ、ハハッ、ごめんねベンタ！"

# game/script.rpy:2742
translate japanese spr_cho2_2_accepted_6ec38f64:
    ...
    "仔犬が無事かどうか確認するために振り向くと、ほっとしたことに、彼はあなたを見上げて愛おしそうに耳を舐めてきた。"

# game/script.rpy:2743
translate japanese spr_cho2_2_accepted_d8d6b8df:

    # wilson_char "Looks like another successful mission for us! Shall we leave the rest to the team?"
    wilson_char "今回もミッションは成功したってことだね！後処理は他の班に任せてもいい？"

# game/script.rpy:2744
translate japanese spr_cho2_2_accepted_7df46984:

    # wilson_char "Let's head back and ensure Vanta wasn't impacted by the blast."
    wilson_char "早く戻ってベンタが爆発の影響を受けていないかを確認しよう。"

# game/script.rpy:2745
translate japanese spr_cho2_2_accepted_5d174c52:

    # zali_char "Yeah, Wilson has a point. Vanta, you feeling alright?"
    zali_char "そう、ウィルソンの言う通りだ。ベンタ、気分はどう？大丈夫そう？"

# game/script.rpy:2746
translate japanese spr_cho2_2_accepted_cea7de1b:

    # "There's a hint of melancholy in your voice as you take a deep breath, the flashbacks still vivid in your mind."
    "深呼吸をするあなたの声には哀愁が漂い、さっきまでの出来事がまだ鮮明に頭に残っている。"

# game/script.rpy:2747
translate japanese spr_cho2_2_accepted_2374cc69:
    ...
    "最も危険な瞬間でさえ、仲間たちが身を挺してあなたを守ってくれたという事実は、あなたを溢れ出すほどの温かさで満たす。"
...
translate japanese spr_cho2_2_accepted_5b0b42d5:
    ...
    "ちょうどその時、ヴェズクルーニアズたちが着いた。彼らは陽気にあなたたち三人を取り囲んでいて、その道のりの一歩一歩を支えてくれたことを常に思い出させてくれる。"

# game/script.rpy:2752
translate japanese spr_cho2_2_accepted_74c404c7:
    ...
    vanta_char "かつてのベンタクロウ・ブリンガーは孤独だったが、今は違う。お前たちのおかげでここまでこれたんだ。"

# game/script.rpy:2753
translate japanese spr_cho2_2_accepted_c6b7fc50:

    # "Zali places a reassuring hand on your shoulder. "
    "ザリの温かい手があなたの肩に置かれた。"

# game/script.rpy:2754
translate japanese spr_cho2_2_accepted_afc47b13:
    ...
    zali_char "よくやっているよ、ベンタ。私たち三人は一心同体ってことさ。時々Krisになることもあるけれど、それでもいつだってKrisisに支えられるんだよ、永遠にね。"

# game/script.rpy:2755
translate japanese spr_cho2_2_accepted_aac31ea0:

    # "Wilson nods, a grin spreading across his face. He lightly bumps your chest with his fist."
    "ウィルソンは頷き笑顔を向け、拳であなたの胸をぽんと軽く叩く。"
...
translate japanese spr_cho2_2_accepted_977ce245:
    ...
    "自分の周りにいるみんなを見て、誇らしい気持ちがあなたの胸にこみ上げてくる。"

# game/script.rpy:2770
translate japanese spr_cho2_2_accepted_79ec57b6:
    ...
    "笑い声がこみ上げてきて、これまでのふざけ合いや言い争いを思い出す。あなたの背中に乗っている仔犬もモフモフした頭であなたを軽く叩き、励ましてくれる。"
...
translate japanese spr_cho2_2_accepted_107fb70b:
    ...
    "桜の花びらが絨毯のように地面を覆い優しく揺れる中、あなたはザリとウィルソンと腕を組み、後ろの瓦礫から離れた。"
...
translate japanese strings:
    ...
    new "茄子型ペロペロキャンディーを贈る"

# TODO: Translation updated at 2024-06-08 22:45

# game/script.rpy:2360
translate japanese chapter_4_787fe774:
...
# game/script.rpy:2369
translate japanese chapter_4_41b82195:

    # wilson_char "My coffee creamer."
    wilson_char "僕のバニラクリーマー。"

# game/script.rpy:2460
translate japanese spr_cho2_1_accepted_de1c0c17:
...
translate japanese spr_cho2_1_accepted_3ec36bf9:
